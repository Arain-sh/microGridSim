...
(function(V, L) {
    ...
    var L = function() {
        var a = "undefined" === typeof V ? window : V
          ...
          , v = m && 4 > parseInt(C.split("Firefox/")[1], 10);
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                ...
                if (1 === v)
                    ...
                    for (; z--; )
                        u = parseFloat(a[z]),
                        g[z] = isNaN(u) ? m[z] : v * parseFloat(m[z] - u) + u;
                else
                    g = m;
            ...
            run: function(p, m, g) {
                ...
                p !== m || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date,
                this.start = p,
                this.end = m,
                this.unit = g,
                this.now = this.start,
                ...
                u.elem = this.elem,
                u.prop = this.prop,
                u() && 1 === a.timers.push(u) && y(l)) : (delete z.curAnim[this.prop],
                z.complete && 0 === a.keys(z.curAnim).length && z.complete.call(this.elem))
            },
            step: function(p) {
                var m = +new Date, g, v = this.options, z = this.elem, u = v.complete, y = v.duration, l = v.curAnim;
                z.attr && !z.element ? p = !1 : p || m >= y + this.startTime ? (this.now = this.end,
                this.pos = 1,
                this.update(),
                g = l[this.prop] = !0,
                ...
                g && u && u.call(z),
                p = !1) : (this.pos = v.easing((m - this.startTime) / y),
            ...
            initPath: function(p, m, g) {
                function v(a) {
                    ...
                    for (c = a.length; c--; )
                        b = "M" === a[c] || "L" === a[c],
                        f = /[a-zA-Z]/.test(a[c + 3]),
                        b && f && a.splice(c + 1, 0, a[c + 1], a[c + 2], a[c + 1], a[c + 2])
                }
                function z(a, b) {
                    for (; a.length < n; ) {
                        a[0] = b[n - a.length];
                ...
                function u(a, b) {
                    for (var c = (n - a.length) / t; 0 < c && c--; )
                        f = a.slice().splice(a.length / w - t, t * w),
                        f[0] = b[n - t - c * t],
                        e && (f[t - 6] = f[t - 2],
                        f[t - 5] = f[t - 1]),
                        [].splice.apply(a, [a.length / w, 0].concat(f)),
                        h && c--
                }
                m = m || "";
        ...
        a.formatSingle = function(p, m, g) {
            ...
            /f$/.test(p) ? (g = (g = p.match(v)) ? g[1] : -1,
            null !== m && (m = a.numberFormat(m, g, z.decimalPoint, -1 < p.indexOf(",") ? z.thousandsSep : ""))) : m = (g || a.time).dateFormat(p, m);
            return m
        }
        ;
        ...
        a.normalizeTickInterval = function(p, m, g, v, z) {
            ...
            g = a.pick(g, 1);
            u = p / g;
            m || (m = z ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10],
            !1 === v && (1 === g ? m = a.grep(m, function(a) {
                return 0 === a % 1
            }) : .1 >= g && (m = [1 / g])));
            for (v = 0; v < m.length && !(y = m[v],
            z && y * g >= p || !z && u <= (m[v] + (m[v + 1] || m[v])) / 2); v++)
                ;
        ...
        a.numberFormat = function(p, m, g, v) {
            p = +p || 0;
            m = +m;
            var z = a.defaultOptions.lang, u = (p.toString().split(".")[1] || "").split("e")[0].length, y, l, b = p.toString().split("e");
            -1 === m ? m = Math.min(u, 20) : a.isNumber(m) ? m && b[1] && 0 > b[1] && (y = m + +b[1],
            0 <= y ? (b[0] = (+b[0]).toExponential(y).split("e")[0],
            m = y) : (b[0] = b[0].split(".")[0] || 0,
            p = 20 > m ? (b[0] * Math.pow(10, b[1])).toFixed(m) : 0,
            b[1] = 0)) : m = 2;
            l = (Math.abs(b[1] ? b[0] : p) + Math.pow(10, -Math.max(m, u) - 1)).toFixed(m);
            u = String(a.pInt(l));
            y = 3 < u.length ? u.length % 3 : 0;
            g = a.pick(g, z.decimalPoint);
        ...
        a.getStyle = function(p, m, g) {
            ...
            if (p = G.getComputedStyle(p, void 0))
                p = p.getPropertyValue(m),
                a.pick(g, "opacity" !== m) && (p = a.pInt(p));
            return p
        }
        ;
        ...
        a.some = function(p, m, g) {
            return (a.somePolyfill || Array.prototype.some).call(p, m, g)
        }
        ;
        a.map = function(a, m) {
            for (var g = [], v = 0, z = a.length; v < z; v++)
                g[v] = m.call(a[v], a[v], v, a);
            return g
        }
        ;
        a.keys = function(p) {
        ...
        a.stop = function(p, m) {
            for (var g = a.timers.length; g--; )
                a.timers[g].elem !== p || m && m !== a.timers[g].prop || (a.timers[g].stopped = !0)
        }
        ;
        ...
        a.objectEach = function(a, m, g) {
            for (var v in a)
                a.hasOwnProperty(v) && m.call(g || a[v], a[v], v, a)
        }
        ;
        ...
        a.fireEvent = function(p, m, g, v) {
            var z, u, y, l, b;
            g = g || {};
            C.createEvent && (p.dispatchEvent || p.fireEvent) ? (z = C.createEvent("Events"),
            z.initEvent(m, !0, !0),
            a.extend(z, g),
            p.dispatchEvent ? p.dispatchEvent(z) : p.fireEvent(m, z)) : a.each(["protoEvents", "hcEvents"], function(e) {
                if (p[e])
                    for (u = p[e][m] || [],
                    y = u.length,
                    g.target || a.extend(g, {
                    ...
                    l = 0; l < y; l++)
                        (b = u[l]) && !1 === b.call(p, g) && g.preventDefault()
            });
            v && !g.defaultPrevented && v.call(p, g)
        }
        ;
        a.animate = function(p, m, g) {
            var v, z = "", u, y, l;
            a.isObject(g) || (l = arguments,
            g = {
                duration: l[2],
                easing: l[3],
                complete: l[4]
            ...
            a.objectEach(m, function(b, e) {
                ...
                y = new a.Fx(p,g,e);
                u = null;
                "d" === e ? (y.paths = y.initPath(p, p.d, m.d),
                y.toD = m.d,
                v = 0,
                u = 1) : p.attr ? v = p.attr(e) : (v = parseFloat(a.getStyle(p, e)) || 0,
                "opacity" !== e && (z = "px"));
                u || (u = b);
        ...
        a.Color.prototype = {
            ...
            init: function(g) {
                ...
                if ((this.input = g = this.names[g && g.toLowerCase ? g.toLowerCase() : ""] || g) && g.stops)
                    this.stops = G(g.stops, function(l) {
                        return new a.Color(l[1])
                    });
                else if (g && g.charAt && "#" === g.charAt() && (m = g.length,
                g = parseInt(g.substr(1), 16),
                7 === m ? z = [(g & 16711680) >> 16, (g & 65280) >> 8, g & 255, 1] : 4 === m && (z = [(g & 3840) >> 4 | (g & 3840) >> 8, (g & 240) >> 4 | g & 240, (g & 15) << 4 | g & 15, 1])),
                !z)
                    for (u = this.parsers.length; u-- && !z; )
                        y = this.parsers[u],
                        (m = y.regex.exec(g)) && (z = y.parse(m));
                this.rgba = z || []
            },
            get: function(a) {
            ...
            tweenTo: function(a, m) {
                var g = this.rgba
                  , u = a.rgba;
                u.length && g && g.length ? (a = 1 !== u[3] || 1 !== g[3],
                m = (a ? "rgba(" : "rgb(") + Math.round(u[0] + (g[0] - u[0]) * (1 - m)) + "," + Math.round(u[1] + (g[1] - u[1]) * (1 - m)) + "," + Math.round(u[2] + (g[2] - u[2]) * (1 - m)) + (a ? "," + (u[3] + (g[3] - u[3]) * (1 - m)) : "") + ")") : m = a.input || "none";
                return m
            }
        };
        a.color = function(g) {
    ...
    (function(a) {
        ...
        n(B.prototype, {
            ...
            animate: function(k, d, A) {
                ...
                0 !== d.duration ? (A && (d.complete = A),
                p(this, k, d)) : (this.attr(k, null, A),
                d.step && d.step.call(this));
                return this
            },
            complexColor: function(k, d, A) {
                ...
                a.fireEvent(this.renderer, "complexColor", {
                    ...
                    "radialGradient" === f && w && !y(c.gradientUnits) && (h = c,
                    c = K(c, M.getRadialAttr(w, h), {
                        gradientUnits: "userSpaceOnUse"
                    })),
                    H(c, function(a, k) {
                        "id" !== k && q.push(k, a)
                    ...
                    q = q.join(","),
                    I[q] ? E = I[q].attr("id") : (c.id = E = a.uniqueKey(),
                    I[q] = x = M.createElement(f).attr(c).add(M.defs),
                    x.radAttr = h,
                    x.stops = [],
                    t(n, function(k) {
            ...
            applyTextOutline: function(k) {
                ...
                if ((b = k[0]) && "none" !== b && a.svg) {
                    ...
                    for (h = k.length; h--; )
                        M = k[h],
                        "highcharts-text-outline" === M.getAttribute("class") && f(k, d.removeChild(M));
                    c = d.firstChild;
                    t(k, function(a, k) {
                        0 === k && (a.setAttribute("x", d.getAttribute("x")),
                        k = d.getAttribute("y"),
                        a.setAttribute("y", k || 0),
                        null === k && d.setAttribute("y", 0));
                        a = a.cloneNode(1);
                        m(a, {
            ...
            attr: function(a, k, d, A) {
                var M, b = this.element, f, c = this, h, I;
                "string" === typeof a && void 0 !== k && (M = a,
                a = {},
                a[M] = k);
                "string" === typeof a ? c = (this[a + "Getter"] || this._defaultGetter).call(this, a, b) : (H(a, function(k, d) {
                    ...
                    h || (I = this[d + "Setter"] || this._defaultSetter,
                    I.call(this, k, d, b),
                    this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(d) && this.updateShadows(d, k, I))
                }, this),
                this.afterSetters());
                d && d.call(this);
                return c
            ...
            updateShadows: function(a, k, d) {
                for (var M = this.shadows, A = M.length; A--; )
                    d.call(M[A], "height" === a ? Math.max(k - (M[A].cutHeight || 0), 0) : "d" === a ? this.d : k, a, M[A])
            },
            addClass: function(a, k) {
                var d = this.attr("class") || "";
                -1 === d.indexOf(a) && (k || (a = (d + (d ? " " : "") + a).replace("  ", " ")),
                this.attr("class", a));
                return this
            },
            hasClass: function(a) {
            ...
            css: function(a) {
                var d = this.styles, A = {}, b = this.element, f, c = "", M, h = !d, I = ["textOutline", "textOverflow", "width"];
                ...
                h && (d && (a = n(d, A)),
                f = this.textWidth = a && a.width && "auto" !== a.width && "text" === b.nodeName.toLowerCase() && k(a.width),
                this.styles = a,
                f && !R && this.renderer.forExport && delete a.width,
                b.namespaceURI === this.SVG_NS ? (M = function(a, k) {
            ...
            on: function(a, k) {
                var d = this
                  , A = d.element;
                h && "click" === a ? (A.ontouchstart = function(a) {
            ...
            updateTransform: function() {
                ...
                (y(d) || y(A)) && a.push("scale(" + E(d, 1) + " " + E(A, 1) + ")");
            ...
            getBBox: function(a, k) {
                var d, A = this.renderer, b, c = this.element, f = this.styles, h, I = this.textStr, M, x = A.cache, r = A.cacheKeys, e;
                k = E(k, this.rotation);
                b = k * l;
                h = f && f.fontSize;
                y(I) && (e = I.toString(),
                -1 === e.indexOf("\x3c") && (e = e.replace(/[0-9]/g, "0")),
                e += ["", k || 0, h, this.textWidth, f && f.textOverflow].join());
                e && !a && (d = x[e]);
                if (!d) {
                    ...
                    A.isSVG && (a = d.width,
                    A = d.height,
                    f && "11px" === f.fontSize && 17 === Math.round(A) && (d.height = A = 14),
                    k && (d.width = Math.abs(A * Math.sin(b)) + Math.abs(a * Math.cos(b)),
                    d.height = Math.abs(A * Math.cos(b)) + Math.abs(a * Math.sin(b))));
                    if (e && 0 < d.height) {
                        for (; 250 < r.length; )
                            delete x[r.shift()];
                        x[e] || r.push(e);
            ...
            add: function(a) {
                var k = this.renderer, d = this.element, A;
            ...
            destroy: function() {
                ...
                if (a.stops) {
                    for (A = 0; A < a.stops.length; A++)
                        a.stops[A] = a.stops[A].destroy();
                    a.stops = null
                }
                a.safeRemoveChild(k);
            ...
            shadow: function(a, k, d) {
                ...
                if (!a)
                    ...
                    for (b = 1; b <= I; b++)
                        ...
                        d && (m(c, "height", Math.max(m(c, "height") - h, 0)),
                        c.cutHeight = h),
                        k ? k.element.appendChild(c) : f.parentNode && f.parentNode.insertBefore(c, f),
                        A.push(c);
                    this.shadows = A
                }
                return this
            ...
            titleSetter: function(a) {
                ...
                k || (k = e.createElementNS(this.SVG_NS, "title"),
                this.element.appendChild(k));
                k.firstChild && k.removeChild(k.firstChild);
                k.appendChild(e.createTextNode(String(E(a), "").replace(/<[^>]*>/g, "").replace(/&lt;/g, "\x3c").replace(/&gt;/g, "\x3e")))
            },
            ...
            zIndexSetter: function(a, d) {
                var A = this.renderer, b = this.parentGroup, c = (b || A).element || A.box, f, h = this.element, I, x, A = c === A.box;
                f = this.added;
                var n;
                y(a) && (h.zIndex = a,
                a = +a,
                ...
                if (f) {
                    ...
                    for (n = d.length - 1; 0 <= n && !I; n--)
                        ...
                        b !== h)
                            if (0 > a && x && !A && !n)
                                c.insertBefore(h, d[n]),
                                I = !0;
                            else if (k(f) <= a || x && (!y(a) || 0 <= a))
                                c.insertBefore(h, d[n + 1] || null),
                                I = !0;
                    I || (c.insertBefore(h, d[A ? 3 : 0] || null),
                    I = !0)
                }
                return I
            },
        ...
        B.prototype.translateXSetter = B.prototype.translateYSetter = B.prototype.rotationSetter = B.prototype.verticalAlignSetter = B.prototype.rotationOriginXSetter = B.prototype.rotationOriginYSetter = B.prototype.scaleXSetter = B.prototype.scaleYSetter = B.prototype.matrixSetter = function(a, k) {
            this[k] = a;
            this.doTransform = !0
        }
        ;
        B.prototype["stroke-widthSetter"] = B.prototype.strokeSetter = function(a, k, d) {
            ...
            this.hasStroke = !0) : "stroke-width" === k && 0 === a && this.hasStroke && (d.removeAttribute("stroke"),
            this.hasStroke = !1)
        }
        ;
        ...
        n(C.prototype, {
            ...
            init: function(a, k, d, A, b, c) {
                ...
                this.boxWrapper = A;
                this.alignedObjects = [];
                this.url = (r || x) && e.getElementsByTagName("base").length ? N.location.href.replace(/#.*?$/, "").replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
                ...
                ,
                k(),
                this.unSubPixelFix = G(N, "resize", k))
            },
            getStyle: function(a) {
                return this.style = n({
            ...
            buildText: function(a) {
                var d = a.element, A = this, b = A.forExport, f = E(a.textStr, "").toString(), h = -1 !== f.indexOf("\x3c"), x = d.childNodes, n, r = m(d, "x"), q = a.styles, l = a.textWidth, D = q && q.lineHeight, F = q && q.textOutline, P = q && "ellipsis" === q.textOverflow, K = q && "nowrap" === q.whiteSpace, M = q && q.fontSize, J, g, Q = x.length, q = l && !a.added && this.box, u = function(a) {
                    var b;
                    ...
                    d = a.indexOf(k + "\x3d");
                    if (-1 !== d && (d = d + k.length + 1,
                    k = a.charAt(d),
                    '"' === k || "'" === k))
                        return a = a.substring(d + 1),
                        a.substring(0, a.indexOf(k))
                };
                J = [f, P, K, D, F, M, l].join();
                if (J !== a.textCache) {
                    for (a.textCache = J; Q--; )
                        d.removeChild(x[Q]);
                    h || F || P || l || -1 !== f.indexOf(" ") ? (q && q.appendChild(d),
                    f = h ? f.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [f],
                    f = c(f, function(a) {
                        return "" !== a
                    }),
                    t(f, function(k, f) {
                        ...
                        t(c, function(k) {
                            if ("" !== k || 1 === c.length) {
                                ...
                                if (w = N(k, "style"))
                                    w = w.replace(/(;| |^)color([ :])/, "$1fill$2"),
                                    m(q, "style", w);
                                (E = N(k, "href")) && !b && (m(q, "onclick", 'location.href\x3d"' + E + '"'),
                                m(q, "class", "highcharts-anchor"),
                                z(q, {
                                    cursor: "pointer"
                                }));
                                ...
                                if (" " !== k) {
                                    ...
                                    if (l) {
                                        ...
                                        for (P && (n = A.applyEllipsis(a, q, k, l)); !P && E && (x.length || H.length); )
                                            a.rotation = 0,
                                            D = A.getSpanWidth(a, q),
                                            k = D > l,
                                            void 0 === n && (n = k),
                                            k && 1 !== x.length ? (q.removeChild(q.firstChild),
                                            H.unshift(x.pop())) : (x = H,
                                            H = [],
                                            x.length && !K && (q = e.createElementNS(I, "tspan"),
                                            m(q, {
                                                dy: t,
                                                x: r
                                            }),
                                            ...
                                            d.appendChild(q)),
                                            D > l && (l = D)),
                                            x.length && q.appendChild(e.createTextNode(x.join(" ").replace(/- /g, "-")));
                                        a.rotation = F
                                    }
                                    h++
                                }
                    ...
                    n && a.attr("title", y(a.textStr, ["\x26lt;", "\x26gt;"])),
                    q && q.removeChild(d),
                    F && a.applyTextOutline && a.applyTextOutline(F)) : d.appendChild(e.createTextNode(y(f)))
                }
            },
            ...
            image: function(a, k, d, A, b, f) {
                ...
                f ? (I(h.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"),
                c = new N.Image,
                G(c, "load", function(k) {
                    I(h.element, a);
                    f.call(h, k)
            ...
            symbol: function(a, k, d, A, b, c) {
                var f = this, h, I = /^url\((.*?)\)$/, x = I.test(a), q = !x && (this.symbols[a] ? a : "circle"), r = q && this.symbols[q], w = y(k) && r && r.call(this.symbols, Math.round(k), Math.round(d), A, b, c), l, H;
                r ? (h = this.path(w),
                h.attr("fill", "none"),
                n(h, {
                    symbolName: q,
                ...
                c && n(h, c)) : x && (l = a.match(I)[1],
                h = this.image(l),
                h.imgwidth = E(Q[l] && Q[l].width, c && c.width),
                h.imgheight = E(Q[l] && Q[l].height, c && c.height),
                H = function() {
                    h.attr({
                        width: h.width,
                        height: h.height
                ...
                t(["width", "height"], function(a) {
                    h[a + "Setter"] = function(a, k) {
                        ...
                        this[k] = a;
                        y(A) && (this.element && this.element.setAttribute(k, A),
                        this.alignByTranslate || (d[b] = ((this[k] || 0) - A) / 2,
                        this.attr(d)))
                    }
                }),
                y(k) && h.attr({
                ...
                h.isImg = !0,
                y(h.imgwidth) && y(h.imgheight) ? H() : (h.attr({
                    width: 0,
                    height: 0
                }),
                u("img", {
            ...
            symbols: {
                ...
                callout: function(a, k, d, A, b) {
                    ...
                    b = b && b.anchorY;
                    var I;
                    I = ["M", a + c, k, "L", a + d - c, k, "C", a + d, k, a + d, k, a + d, k + c, "L", a + d, k + A - c, "C", a + d, k + A, a + d, k + A, a + d - c, k + A, "L", a + c, k + A, "C", a, k + A, a, k + A, a, k + A - c, "L", a, k + c, "C", a, k, a, k, a + c, k];
            ...
            text: function(a, k, d, A) {
                ...
                A || (a.xSetter = function(a, k, d) {
                    ...
                    for (f = 0; f < A.length; f++)
                        b = A[f],
                        b.getAttribute(k) === c && b.setAttribute(k, a);
                    d.setAttribute(k, a)
                }
                );
                return a
            ...
            label: function(k, d, b, c, f, h, I, x, q) {
                var r = this, e = r.g("button" !== q && "label"), w = e.text = r.text("", 0, 0, I).attr({
                    zIndex: 1
                ...
                p = function() {
                    ...
                    z && (E || (e.box = E = r.symbols[c] || v ? r.symbol(c) : r.rect(),
                    E.addClass(("button" === q ? "" : "highcharts-label-box") + (q ? " highcharts-" + q + "-box" : "")),
                    E.add(e),
                    a = M(),
                    k.x = a,
                    k.y = (x ? -N : 0) + a),
                    k.width = Math.round(e.width),
                    k.height = Math.round(e.height),
                    E.attr(n(k, m)),
                    m = {})
                }
                ;
        ...
        g(a.SVGElement.prototype, {
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === b.tagName) {
                        var q = this.rotation, x = this.textWidth && l(this.textWidth), K = [q, r, b.innerHTML, this.textWidth, this.textAlign].join(), d;
                        ...
                        this.oldTextWidth = x);
                        K !== this.cTT && (F = a.fontMetrics(b.style.fontSize).b,
                        p(q) && q !== (this.oldRotation || 0) && this.setSpanRotation(q, t, F),
                        this.getSpanCorrection(!p(q) && this.textPxLength || b.offsetWidth, F, t, q, r));
                        G(b, {
        ...
        a.Time.prototype = {
            ...
            update: function(g) {
                ...
                this.set = function(l, b, e) {
                    var t;
                    if (-1 !== a.inArray(l, ["Milliseconds", "Seconds", "Minutes"]))
                        b["set" + l](e);
                    else
                        t = y.getTimezoneOffset(b),
                        t = b.getTime() - t,
                        b.setTime(t),
                        b["setUTC" + l](e),
                        l = y.getTimezoneOffset(b),
                        t = b.getTime() + l,
                        b.setTime(t)
                }
            ...
            makeTime: function(g, u, y, l, b, e) {
                var t, n, f;
                this.useUTC ? (t = this.Date.UTC.apply(0, arguments),
                n = this.getTimezoneOffset(t),
                t += n,
                f = this.getTimezoneOffset(t),
                n !== f ? t += f - n : n - 36E5 !== this.getTimezoneOffset(t - 36E5) || a.isSafari || (t -= 36E5)) : t = (new this.Date(g,u,m(y, 1),m(l, 0),m(b, 0),m(e, 0))).getTime();
                return t
            },
            ...
            dateFormat: function(g, m, y) {
                ...
                a.objectEach(b, function(a, b) {
                    for (; -1 !== g.indexOf("%" + b); )
                        g = g.replace("%" + b, "function" === typeof a ? a.call(l, m) : a)
                });
            ...
            getTimeTicks: function(a, u, y, l) {
                ...
                if (B(u)) {
                    b.set("Milliseconds", f, c >= g.second ? 0 : h * Math.floor(b.get("Milliseconds", f) / h));
                    ...
                    c >= g.month && (b.set("Month", f, c >= g.year ? 0 : h * Math.floor(b.get("Month", f) / h)),
                    n = b.get("FullYear", f));
                    c >= g.year && b.set("FullYear", f, n - n % h);
                    c === g.week && b.set("Date", f, b.get("Date", f) - b.get("Day", f) + m(l, 1));
                    n = b.get("FullYear", f);
                    l = b.get("Month", f);
                    var D = b.get("Date", f)
                      , r = b.get("Hours", f);
                    ...
                    for (u = 1; f < y; )
                        e.push(f),
                        f = c === g.year ? b.makeTime(n + u * h, 0) : c === g.month ? b.makeTime(n, l + u * h) : !w || c !== g.day && c !== g.week ? w && c === g.hour && 1 < h ? b.makeTime(n, l, D, r + u * h) : f + c * h : b.makeTime(n, l, D + u * h * (c === g.day ? 1 : 7)),
                        u++;
                    e.push(f);
                    c <= g.hour && 1E4 > e.length && C(e, function(a) {
                        0 === a % 18E5 && "000000000" === b.dateFormat("%H%M%S%L", a) && (t[a] = "day")
                    })
                }
                e.info = G(a, {
                    higherRanks: t,
    ...
    (function(a) {
        ...
        a.Tick.prototype = {
            addLabel: function() {
                var a = this.axis, m = a.options, l = a.chart, b = a.categories, e = a.names, t = this.pos, n = m.labels, f = a.tickPositions, c = t === f[0], h = t === f[f.length - 1], e = b ? v(b[t], e[t], t) : t, b = this.label, f = f.info, w;
                ...
                if (C(b))
                    ...
                    if (this.label = b = C(m) && n.enabled ? l.renderer.text(m, 0, 0, n.useHTML).css(g(n.style)).add(a.labelGroup) : null)
            ...
            handleOverflow: function(a) {
                var g = this.axis, l = g.options.labels, b = a.x, e = g.chart.chartWidth, t = g.chart.spacing, n = v(g.labelLeft, Math.min(g.pos, t[3])), t = v(g.labelRight, Math.max(g.isRadial ? 0 : g.pos + g.len, e - t[1])), f = this.label, c = this.rotation, h = {
                    left: 0,
                    center: .5,
                    right: 1
                }[g.labelAlign || f.attr("align")], w = f.getBBox().width, D = g.getSlotWidth(), r = D, J = 1, q, F = {};
                if (c || !1 === l.overflow)
                    0 > c && b - h * w < n ? q = Math.round(b / Math.cos(c * z) - n) : 0 < c && b + h * w > t && (q = Math.round((e - b) / Math.cos(c * z)));
                else if (e = b + (1 - h) * w,
                b - h * w < n ? r = a.x + r * (1 - h) - n : e > t && (r = t - a.x + r * h,
                J = -1),
                r = Math.min(D, r),
                r < D && "center" === g.labelAlign && (a.x += J * (D - r - h * (D - Math.min(w, r)))),
                w > r || g.autoRotation && (f.styles || {}).width)
                    q = r;
                q && (F.width = q,
            ...
            getPosition: function(g, m, l, b) {
                ...
                g = {
                    x: g ? a.correctFloat(e.translate(m + l, null, null, b) + e.transB) : e.left + e.offset + (e.opposite ? (b && t.oldChartWidth || t.chartWidth) - e.right - e.left : 0),
            ...
            getLabelPosition: function(a, g, l, b, e, t, n, f) {
                var c = this.axis
                  ...
                  , F = {};
                C(J) || (J = 0 === c.side ? l.rotation ? -8 : -l.getBBox().height : 2 === c.side ? r.y + 8 : Math.cos(l.rotation * z) * (r.y - l.getBBox(!1, 0).height / 2));
            ...
            renderGridLine: function(a, g, l) {
                ...
                c || (n.zIndex = 1),
                a && (n.opacity = 0),
                this.gridLine = t = w.path().attr(n).addClass("highcharts-" + (c ? c + "-" : "") + "grid-line").add(b.gridGroup));
                if (!a && t && (a = b.getPlotLinePath(f + h, t.strokeWidth() * l, a, !0)))
                    t[this.isNew ? "attr" : "animate"]({
                        d: a,
                        opacity: g
                    })
            },
            renderMark: function(a, g, l) {
                ...
                var r = v(e[f + "Width"], !n && b.isXAxis ? 1 : 0)
                  , e = e[f + "Color"];
                c && (b.opposite && (c[0] = -c[0]),
                w && (this.mark = h = t.path().addClass("highcharts-" + (n ? n + "-" : "") + "tick").add(b.axisGroup),
                h.attr({
                    stroke: e,
                    "stroke-width": r
                })),
            ...
            renderLabel: function(a, g, l, b) {
                var e = this.axis
                  ...
                  , D = a.x;
                a = a.y;
                f && m(D) && (f.xy = a = this.getLabelPosition(D, a, f, t, c, e, b, h),
                this.isFirst && !this.isLast && !v(n.showFirstLabel, 1) || this.isLast && !this.isFirst && !v(n.showLastLabel, 1) ? w = !1 : !t || c.step || c.rotation || g || 0 === l || this.handleOverflow(a),
                h && b % h && (w = !1),
                w && m(a.y) ? (a.opacity = l,
    ...
    var da = function(a) {
        ...
        a.extend(E.prototype, {
            ...
            init: function(a, d) {
                ...
                d = b.options.events;
                -1 === c(b, a.axes) && (k ? a.axes.splice(a.xAxis.length, 0, b) : a.axes.push(b),
                a[b.coll].push(b));
                b.series = b.series || [];
            ...
            defaultLabelFormatter: function() {
                var k = this.axis, d = this.value, b = k.chart.time, c = k.categories, f = this.dateTimeLabelFormat, h = v.lang, x = h.numericSymbols, h = h.numericSymbolMagnitude || 1E3, e = x && x.length, r, n = k.options.labels.format, k = k.isLog ? Math.abs(d) : k.tickInterval;
                if (n)
                    r = t(n, this, b);
                else if (c)
                    r = d;
                    ...
                    for (; e-- && void 0 === r; )
                        b = Math.pow(h, e + 1),
                        k >= b && 0 === 10 * d % b && null !== x[e] && 0 !== d && (r = a.numberFormat(d / b, -1) + x[e]);
                    ...
                    l(a.series, function(k) {
                        if (k.visible || !d.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis)
                                ...
                                b.length && (k = p(b),
                                c = G(b),
                                w(k) || k instanceof Date || (b = f(b, w),
                                k = p(b),
                                c = G(b)),
                                b.length && (a.dataMin = Math.min(F(a.dataMin, b[0], k), k),
                                a.dataMax = Math.max(F(a.dataMax, b[0], c), c)));
                            else if (k.getExtremes(),
                            c = k.dataMax,
                            k = k.dataMin,
                            z(k) && z(c) && (a.dataMin = Math.min(F(a.dataMin, k), k),
                            a.dataMax = Math.max(F(a.dataMax, c), c)),
                            z(A) && (a.threshold = A),
            ...
            translate: function(a, d, b, c, f, h) {
                ...
                x -= A * (k.sector || k.len));
                d ? (a = (a * A + x - e) / I + c,
                f && (a = k.lin2val(a))) : (f && (a = k.val2lin(a)),
                a = w(c) ? A * (a - c) * I + x + A * e + (w(h) ? I * h : 0) : void 0);
                return a
            },
            ...
            getPlotLinePath: function(a, d, b, c, f) {
                var k = this.chart, A = this.left, h = this.top, x, I, e = b && k.oldChartHeight || k.chartHeight, r = b && k.oldChartWidth || k.chartWidth, n;
                x = this.transB;
                var q = function(a, k, d) {
                    if (a < k || a > d)
                        c ? a = Math.min(Math.max(k, a), d) : n = !0;
                    return a
                };
                ...
                w(f) ? this.horiz ? (x = h,
                I = e - this.bottom,
                a = b = q(a, A, A + this.width)) : (a = A,
                b = r - this.right,
                x = I = q(x, h, h + this.height)) : (n = !0,
                c = !1);
                return n && !c ? null : k.renderer.crispLine(["M", a, x, "L", b, I], d || 1)
            },
            ...
            getMinorTickPositions: function() {
                ...
                if (e && e / c < a.len / 3)
                    if (a.isLog)
                        l(this.paddedTicks, function(k, d, b) {
                            d && f.push.apply(f, a.getLogTickPositions(c, b[d - 1], b[d], !0))
                        });
                    else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval())
                        f = f.concat(a.getTimeTicks(a.normalizeTimeTickInterval(c), x, h, d.startOfWeek));
                    else
                        for (d = x + (b[0] - x) % c; d <= h && d !== f[0]; d += c)
                            f.push(d);
            ...
            adjustForMinRange: function() {
                ...
                this.isXAxis && void 0 === this.minRange && !this.isLog && (z(a.min) || z(a.max) ? this.minRange = null : (l(this.series, function(a) {
                    r = a.xData;
                ...
                c = (q - b + d) / 2,
                c = [d - c, F(a.min, d - c)],
                f && (c[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
                d = G(c),
                b = [d + q, F(a.max, d + q)],
            ...
            nameToX: function(a) {
                ...
                -1 === b ? k || (f = d.length) : f = b;
                void 0 !== f && (this.names[f] = a.name,
                this.names.keys[a.name] = f);
                return f
            },
            updateNames: function() {
                ...
                l(this.series || [], function(a) {
                    ...
                    l(a.points, function(d, b) {
                        var c;
                        d.options && (c = k.nameToX(d),
                        void 0 !== c && c !== d.x && (d.x = c,
                        a.xData[b] = c))
                    })
                }))
            },
            setAxisTranslation: function(a) {
                var k = this, d = k.max - k.min, b = k.axisPointRange || 0, c, f = 0, h = 0, x = k.linkedParent, r = !!k.categories, n = k.transA, q = k.isXAxis;
                if (q || r || b)
                    c = k.getClosest(),
                    x ? (f = x.minPointOffset,
                    h = x.pointRangePadding) : l(k.series, function(a) {
                        var d = r ? 1 : q ? F(a.options.pointRange, c, 0) : k.axisPointRange || 0;
                        a = a.options.pointPlacement;
                        b = Math.max(b, d);
                        k.single || (f = Math.max(f, D(a) ? 0 : d / 2),
                        h = Math.max(h, "on" === a ? 0 : d))
                    }),
                    x = k.ordinalSlope && c ? k.ordinalSlope / c : 1,
                    k.minPointOffset = f *= x,
                    k.pointRangePadding = h *= x,
                    k.pointRange = Math.min(b, d),
                    q && (k.closestPointRange = c);
                a && (k.oldTransA = n);
            ...
            setTickInterval: function(k) {
                var d = this, b = d.chart, c = d.options, f = d.isLog, h = d.isDatetimeAxis, x = d.isXAxis, r = d.isLinked, q = c.maxPadding, E = c.minPadding, D = c.tickInterval, H = c.tickPixelInterval, t = d.categories, K = w(d.threshold) ? d.threshold : null, m = d.softThreshold, y, v, u, p;
                h || t || r || this.getTickAmount();
                u = F(d.userMin, c.min);
                p = F(d.userMax, c.max);
                r ? (d.linkedParent = b[d.coll][c.linkedTo],
                b = d.linkedParent.getExtremes(),
                d.min = F(b.min, b.dataMin),
                d.max = F(b.max, b.dataMax),
                c.type !== d.linkedParent.options.type && a.error(11, 1)) : (!m && z(K) && (d.dataMin >= K ? (y = K,
                E = 0) : d.dataMax <= K && (v = K,
                q = 0)),
                d.min = F(u, y, d.dataMin),
                d.max = F(p, v, d.dataMax));
                f && (d.positiveValuesOnly && !k && 0 >= Math.min(d.min, F(d.dataMin, d.min)) && a.error(10, 1),
                d.min = g(d.log2lin(d.min), 15),
                d.max = g(d.log2lin(d.max), 15));
                d.range && z(d.max) && (d.userMin = d.min = u = Math.max(d.dataMin, d.minFromRange()),
                d.userMax = p = d.max,
                d.range = null);
                e(d, "foundExtremes");
                d.beforePadding && d.beforePadding();
                d.adjustForMinRange();
                !(t || d.axisPointRange || d.usePercentage || r) && z(d.min) && z(d.max) && (b = d.max - d.min) && (!z(u) && E && (d.min -= b * E),
                !z(p) && q && (d.max += b * q));
                ...
                m && z(d.dataMin) && (K = K || 0,
                !z(u) && d.min < K && d.dataMin >= K ? d.min = K : !z(p) && d.max > K && d.dataMax <= K && (d.max = K));
            ...
            setTickPositions: function() {
                ...
                d.length > this.len && (d = [d[0], d.pop()],
                d[0] === d[1] && (d.length = 1)),
                this.tickPositions = d,
                c && (c = c.apply(this, [this.min, this.max]))) && (this.tickPositions = d = c);
                this.paddedTicks = d.slice(0);
                this.trimTicks(d, f, h);
                this.isLinked || (this.single && 2 > d.length && (this.min -= .5,
                this.max += .5),
                b || c || this.adjustTickAmount());
            ...
            alignToOthers: function() {
                ...
                !1 === this.chart.options.chart.alignTicks || !1 === b.alignTicks || !1 === b.startOnTick || !1 === b.endOnTick || this.isLog || l(this.chart[this.coll], function(k) {
                    var b = k.options
            ...
            adjustTickAmount: function() {
                ...
                if (this.hasData()) {
                    if (f < b) {
                        for (; d.length < b; )
                            d.length % 2 || this.min === h ? d.push(g(d[d.length - 1] + a)) : d.unshift(g(d[0] - a));
                        this.transA *= (f - 1) / (b - 1);
                        this.min = d[0];
            ...
            setScale: function() {
                ...
                d || a || this.isLinked || this.forceRedraw || this.userMin !== this.oldUserMin || this.userMax !== this.oldUserMax || this.alignToOthers() ? (this.resetStacks && this.resetStacks(),
                this.forceRedraw = !1,
                this.getSeriesExtremes(),
                this.setTickInterval(),
                this.oldUserMin = this.userMin,
                this.oldUserMax = this.userMax,
                this.isDirty || (this.isDirty = d || this.min !== this.oldMin || this.max !== this.oldMax)) : this.cleanStacks && this.cleanStacks();
            ...
            zoom: function(a, d) {
                ...
                if (a !== this.min || d !== this.max)
                    this.allowZoomOutside || (z(k) && (a < f && (a = f),
                    a > c && (a = c)),
                    z(b) && (d < f && (d = f),
                    d > c && (d = c))),
                    this.displayBtn = void 0 !== a || void 0 !== d,
                    this.setExtremes(a, d, !1, void 0, {
                        trigger: "zoom"
                    });
                return !0
            },
            ...
            tickSize: function(a) {
                ...
                if (b && k)
                    return "inside" === d[a + "Position"] && (k = -k),
                    [k, b]
            },
            ...
            unsquish: function() {
                var a = this.options.labels, d = this.horiz, b = this.tickInterval, c = b, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / b), h, x = a.rotation, e = this.labelMetrics(), r, q = Number.MAX_VALUE, n, w = function(a) {
                    a /= f || 1;
                    a = 1 < a ? Math.ceil(a) : 1;
                    return g(a * b)
                };
            ...
            renderUnsquish: function() {
                var a = this.chart, d = a.renderer, b = this.tickPositions, c = this.ticks, f = this.options.labels, h = this.horiz, x = this.getSlotWidth(), e = Math.max(1, Math.round(x - 2 * (f.padding || 5))), r = {}, q = this.labelMetrics(), n = f.style && f.style.textOverflow, w, E, H = 0, t;
                ...
                if (this.autoRotation)
                    H > e && H > q.h ? r.rotation = this.labelRotation : this.labelRotation = 0;
                else if (x && (w = e,
                !n))
                    for (E = "clip",
                    e = b.length; !h && e--; )
                ...
                r.rotation && (w = H > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight,
                n || (E = "ellipsis"));
                ...
                l(b, function(a) {
                    var d = (a = c[a]) && a.label
                      , b = {};
                    d && (d.attr(r),
                    !w || f.style && f.style.width || !(w < d.textPxLength || "SPAN" === d.element.tagName) || (b.width = w,
                    n || (b.textOverflow = d.specificTextOverflow || E),
                    d.css(b)),
            ...
            addTitle: function(a) {
                ...
                this.axisTitle = d.text(c.text, 0, 0, c.useHTML).attr({
                    zIndex: 7,
                    rotation: c.rotation || 0,
                    align: f
                }).addClass("highcharts-axis-title").css(r(c.style)).add(this.axisGroup),
            ...
            getOffset: function() {
                var a = this, d = a.chart, b = d.renderer, c = a.options, f = a.tickPositions, h = a.ticks, x = a.horiz, e = a.side, r = d.inverted && !a.isZAxis ? [1, 0, 3, 2][e] : e, n, w, E = 0, D, H = 0, t = c.title, K = c.labels, g = 0, J = d.axisOffset, d = d.clipOffset, m = [-1, 1, 1, -1][e], y = c.className, v = a.axisParent, u = this.tickSize("tick");
                n = a.hasData();
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (y || "")).add(v),
                a.axisGroup = b.g("axis").attr({
                    zIndex: c.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (y || "")).add(v),
                ...
                a.renderUnsquish(),
                a.reserveSpaceDefault = 0 === e || 2 === e || {
                    1: "left",
                    3: "right"
                }[e] === a.labelAlign,
                F(K.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && l(f, function(a) {
                    g = Math.max(h[a].getLabelSize(), g)
                }),
                a.staggerLines && (g *= a.staggerLines),
                a.labelOffset = g * (a.opposite ? -1 : 1)) : q(h, function(a, d) {
                    a.destroy();
                    delete h[d]
                });
                t && t.text && !1 !== t.enabled && (a.addTitle(w),
                w && !1 !== t.reserveSpace && (a.titleOffset = E = a.axisTitle.getBBox()[x ? "height" : "width"],
                D = t.offset,
                H = z(D) ? 0 : F(t.margin, x ? 5 : 10)));
                a.renderLine();
                ...
                J[e] = Math.max(J[e], a.axisTitleMargin + E + m * a.offset, H, n && f.length && u ? u[0] + m * a.offset : 0);
            ...
            getTitlePosition: function() {
                var a = this.horiz
                  ...
                  , d = (a ? b + this.height : d) + (a ? 1 : -1) * (x ? -1 : 1) * this.axisTitleMargin + [-q, q, w.f, -q][this.side];
                return {
            ...
            renderTick: function(a, d) {
                ...
                if (!b || a >= this.min && a <= this.max)
                    k[a] || (k[a] = new H(this,a)),
                    c && k[a].isNew && k[a].render(d, !0, .1),
                    k[a].render(d)
            },
            render: function() {
                var b = this, c = b.chart, f = b.options, h = b.isLog, x = b.isLinked, r = b.tickPositions, n = b.axisTitle, E = b.ticks, D = b.minorTicks, t = b.alternateBands, K = f.stackLabels, F = f.alternateGridColor, g = b.tickmarkOffset, J = b.axisLine, m = b.showAxis, y = C(c.renderer.globalAnimation), v, u;
                ...
                if (b.hasData() || x)
                    b.minorTickInterval && !b.categories && l(b.getMinorTickPositions(), function(a) {
                        b.renderMinorTick(a)
                    }),
                    r.length && (l(r, function(a, d) {
                        b.renderTick(a, d)
                    }),
                    g && (0 === b.min || b.single) && (E[-1] || (E[-1] = new H(b,-1,null,!0)),
                    E[-1].render(-1))),
                    F && l(r, function(d, k) {
                        u = void 0 !== r[k + 1] ? r[k + 1] + g : b.max - g;
                        0 === k % 2 && d < b.max && u <= b.max + (c.polar ? -g : g) && (t[d] || (t[d] = new a.PlotLineOrBand(b)),
                        v = d + g,
                        t[d].options = {
                ...
                l([E, D, t], function(a) {
                    ...
                    q(a, function(a, d) {
                        a.isActive || (a.render(d, !1, 0),
                        a.isActive = !1,
                        k.push(d))
                    });
                    d(function() {
                        for (b = k.length; b--; )
                            a[k[b]] && !a[k[b]].isActive && (a[k[b]].destroy(),
                            delete a[k[b]])
                ...
                J.isPlaced = !0,
                J[m ? "show" : "hide"](!0));
                n && m && (f = b.getTitlePosition(),
                w(f.y) ? (n[n.isNew ? "attr" : "animate"](f),
                n.isNew = !1) : (n.attr("y", -9999),
                n.isNew = !0));
            ...
            drawCrosshair: function(a, d) {
                ...
                if (this.crosshair && !1 !== (z(d) || !k)) {
                    k ? z(d) && (f = F(d.crosshairPos, this.isXAxis ? d.plotX : this.len - d.plotY)) : f = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos);
    ...
    (function(a) {
        ...
        B.prototype.normalizeTimeTickInterval = function(a, g) {
            ...
            g = m[m.length - 1];
            var z = p[g[0]], u = g[1], y;
            for (y = 0; y < m.length && !(g = m[y],
            z = p[g[0]],
            u = g[1],
            m[y + 1] && a <= (z * u[u.length - 1] + p[m[y + 1][0]]) / 2); y++)
                ;
    ...
    (function(a) {
        ...
        B.prototype.getLogTickPositions = function(a, v, z, u) {
            ...
            if (.5 <= a)
                a = Math.round(a),
                b = this.getLinearTickPositions(a, v, z);
            else if (.08 <= a)
                for (var l = Math.floor(v), e, t, n, f, c, g = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; l < z + 1 && !c; l++)
                    for (t = g.length,
                    e = 0; e < t && !c; e++)
                        n = this.log2lin(this.lin2log(l) * g[e]),
                        n > v && (!u || f <= z) && void 0 !== f && b.push(f),
                        f > z && (c = !0),
                        f = n;
            else
                v = this.lin2log(v),
                z = this.lin2log(z),
                a = u ? this.getMinorTickInterval() : g.tickInterval,
                a = m("auto" === a ? null : a, this._minorAutoInterval, g.tickPixelInterval / (u ? 5 : 1) * (z - v) / ((u ? l / this.tickPositions.length : l) || 1)),
                a = p(a, null, C(a)),
                b = G(this.getLinearTickPositions(a, v, z), this.log2lin),
    ...
    (function(a, B) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                e.dashStyle && (q.dashstyle = e.dashStyle)) : w && (F && (q.fill = F),
                ...
                if (D)
                    q = l.getPlotLinePath(h, r.strokeWidth());
                else if (w)
                    q = l.getPlotBandPath(c, f, e);
                else
                    return;
                J && q && q.length ? (r.attr({
                    d: q
                ...
                this.renderLabel(t, q, w, x)) : n && n.hide();
                return g
            },
            renderLabel: function(a, l, b, e) {
                ...
                t.zIndex = e,
                this.label = t = n.text(a.text, 0, 0, a.useHTML).attr(t).add(),
                t.css(a.style));
        ...
        a.extend(B.prototype, {
            getPlotBandPath: function(a, l) {
                var b = this.getPlotLinePath(l, null, null, !0), e = this.getPlotLinePath(a, null, null, !0), t = [], n = this.horiz, f = 1, c;
                a = a < this.min && l < this.min || a > this.max && l > this.max;
                if (e && b)
                    for (a && (c = e.toString() === b.toString(),
                    f = 0),
                    a = 0; a < e.length; a += 6)
                        n && b[a + 1] === e[a + 1] ? (b[a + 1] += f,
                        b[a + 4] += f) : n || b[a + 2] !== e[a + 2] || (b[a + 2] += f,
                        b[a + 5] += f),
                        t.push("M", e[a + 1], e[a + 2], "L", e[a + 4], e[a + 5], b[a + 4], b[a + 5], b[a + 1], b[a + 2], "z"),
                        t.flat = c;
                return t
            },
            ...
            removePlotBandOrLine: function(a) {
                for (var l = this.plotLinesAndBands, b = this.options, e = this.userOptions, t = l.length; t--; )
                    l[t].id === a && l[t].destroy();
    ...
    (function(a) {
        ...
        a.Tooltip.prototype = {
            ...
            move: function(l, b, e, t) {
                ...
                n.getLabel().attr(f);
                c && (a.clearTimeout(this.tooltipTimeout),
            ...
            getAnchor: function(a, b) {
                ...
                a = z(a);
                e = a[0].tooltipPos;
                this.followPointer && b && (void 0 === b.chartX && (b = l.pointer.normalize(b)),
                e = [b.chartX - l.plotLeft, b.chartY - f]);
                e || (B(a, function(a) {
                    D = a.series.yAxis;
                    r = a.series.xAxis;
                    h += a.plotX + (!n && r ? r.left - c : 0);
                    w += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!n && D ? D.top - f : 0)
                }),
                h /= a.length,
                w /= a.length,
                e = [n ? l.plotWidth - w : h, this.shared && !n && 1 < a.length && b ? b.chartY - f : n ? l.plotHeight - h : w]);
                return m(e, Math.round)
            },
            getPosition: function(a, b, e) {
                var l = this.chart, n = this.distance, f = {}, c = l.inverted && e.h || 0, h, w = ["y", l.chartHeight, b, e.plotY + l.plotTop, l.plotTop, l.plotTop + l.plotHeight], D = ["x", l.chartWidth, a, e.plotX + l.plotLeft, l.plotLeft, l.plotLeft + l.plotWidth], r = !this.followPointer && v(e.ttBelow, !l.inverted === !!e.negative), g = function(a, d, b, h, k, x) {
                    var e = b < h - n
                      , q = h + n + b < d
                      , w = h - n - b;
                    h += n;
                    if (r && q)
                        ...
                        f[a] = Math.min(x - b, 0 > w - c ? w : w - c);
                    else if (q)
                        f[a] = Math.max(k, h + c + b > d ? h : h + c);
                    else
                        return !1
                }, q = function(a, d, b, c) {
                    var k;
                    ...
                    !1 !== g.apply(0, w) ? !1 !== q.apply(0, D) || h || (F(!0),
                    x()) : h ? f.x = f.y = 0 : (F(!0),
                    x())
                };
            ...
            refresh: function(l, b) {
                ...
                var h = this.shared, D;
                t.enabled && (a.clearTimeout(this.hideTimer),
                this.followPointer = z(f)[0].series.tooltipOptions.followPointer,
                c = this.getAnchor(f, b),
                b = c[0],
                n = c[1],
                !h || f.series && f.series.noSharedTooltip ? h = f.getLabelConfig() : (B(f, function(a) {
                    a.setState("hover");
                ...
                h = e.call(h, this),
                D = f.series,
                this.distance = v(D.tooltipOptions.distance, 16),
                !1 === h ? this.hide() : (e = this.getLabel(),
                this.isHidden && e.attr({
                    opacity: 1
                }).show(),
                this.split ? this.renderSplit(h, z(l)) : (t.style.width || e.css({
                    width: this.chart.spacingBox.width
                }),
                e.attr({
                    text: h && h.join ? h.join("") : h
                }),
                e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + v(f.colorIndex, D.colorIndex)),
                e.attr({
                    stroke: t.borderColor || f.color || D.color || "#666666"
                }),
                this.updatePosition({
                    plotX: b,
                    plotY: n,
            ...
            renderSplit: function(l, b) {
                ...
                B(l.slice(0, b.length + 1), function(a, l) {
                    if (!1 !== a) {
                        ...
                        F || (r.tt = F = f.label(null, null, null, "callout", null, null, h.useHTML).addClass("highcharts-tooltip-box " + K).attr({
                            padding: h.padding,
                            r: h.borderRadius,
                        ...
                        l.isHeader ? (w = a.height,
                        x = Math.max(0, Math.min(l.plotX + n.plotLeft - x / 2, n.chartWidth - x))) : x = l.plotX + n.plotLeft - v(h.distance, 16) - x;
                        0 > x && (c = !1);
                        a = (l.series && l.series.yAxis && l.series.yAxis.pos) + (l.plotY || 0);
                        a -= n.plotTop;
                        t.push({
                            target: l.isHeader ? n.plotHeight + w : a,
                            rank: l.isHeader ? 1 : 0,
            ...
            getDateFormat: function(a, b, e, t) {
                var n = this.chart.time, f = n.dateFormat("%m-%d %H:%M:%S.%L", b), c, h, w = {
                    millisecond: 15,
                    second: 12,
                    minute: 9,
                    hour: 6,
                ...
                for (h in y) {
                    ...
                    if (w[h] && f.substr(w[h]) !== "01-01 00:00:00.000".substr(w[h]))
                        break;
                    "week" !== h && (l = h)
                }
                h && (c = t[h]);
    ...
    (function(a) {
        ...
        a.Pointer.prototype = {
            init: function(a, b) {
                ...
                this.pinchDown = [];
                this.lastValidTouch = {};
                f && (a.tooltip = new f(a,b.tooltip),
                this.followTouchMove = t(b.tooltip.followTouchMove, !0));
                this.setDOMEvents()
            },
            ...
            getHoverData: function(c, f, e, n, r, l, q) {
                ...
                h && (r && !f.noSharedTooltip ? (q = a.grep(e, function(a) {
                    return a.visible && !(!r && a.directTouch) && t(a.options.enableMouseTracking, !0) && !a.noSharedTooltip
                }),
                v(q, function(a) {
                    var d = u(a.points, function(a) {
                        return a.x === h.x && !a.isNull
                    });
                    b(d) && (w && (d = a.getPoint(d)),
                    x.push(d))
                })) : x.push(h));
                return {
                    hoverPoint: h,
            ...
            runPointActions: function(b, f) {
                var c = this.chart, h = c.tooltip && c.tooltip.options.enabled ? c.tooltip : void 0, e = h ? h.shared : !1, n = f || c.hoverPoint, q = n && n.series || c.hoverSeries, q = this.getHoverData(n, q, c.series, !!f || q && q.directTouch && this.isDirectTouch, e, b, {
                ...
                if (n && (n !== c.hoverPoint || h && h.isHidden)) {
                    ...
                    f && h && !h.isHidden && (n = h.getAnchor([{}], b),
                    h.updatePosition({
                        plotX: n[0],
                        plotY: n[1]
                    }));
            ...
            scaleGroups: function(a, b) {
                ...
                v(c.series, function(h) {
                    f = a || h.getPlotBox();
                    h.xAxis && h.xAxis.zoomEnabled && h.group && (h.group.attr(f),
                    h.markerGroup && (h.markerGroup.attr(f),
                    h.markerGroup.clip(b ? c.clipRect : null)),
                    h.dataLabelsGroup && h.dataLabelsGroup.attr(f))
                });
            ...
            drag: function(a) {
                var b = this.chart, c = b.options.chart, f = a.chartX, e = a.chartY, n = this.zoomHor, q = this.zoomVert, l = b.plotLeft, x = b.plotTop, t = b.plotWidth, d = b.plotHeight, H, E = this.selectionMarker, k = this.mouseDownX, A = this.mouseDownY, g = c.panKey && a[c.panKey + "Key"];
                E && E.touch || (f < l ? f = l : f > l + t && (f = l + t),
                e < x ? e = x : e > x + d && (e = x + d),
                this.hasDragged = Math.sqrt(Math.pow(k - f, 2) + Math.pow(A - e, 2)),
                10 < this.hasDragged && (H = b.isInsidePlot(k - l, A - x),
                b.hasCartesianSeries && (this.zoomX || this.zoomY) && H && !g && !E && (this.selectionMarker = E = b.renderer.rect(l, x, n ? 1 : t, q ? 1 : d, 0).attr({
            ...
            drop: function(a) {
                ...
                if (this.selectionMarker) {
                    var e = {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, n = this.selectionMarker, q = n.attr ? n.attr("x") : n.x, t = n.attr ? n.attr("y") : n.y, x = n.attr ? n.attr("width") : n.width, K = n.attr ? n.attr("height") : n.height, d;
                    if (this.hasDragged || f)
                        v(c.axes, function(c) {
                            if (c.zoomEnabled && g(c.min) && (f || b[{
                                xAxis: "zoomX",
                                yAxis: "zoomY"
                            }[c.coll]])) {
                                var h = c.horiz
            ...
            onContainerClick: function(a) {
                var b = this.chart
                  ...
                  , e = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (f && this.inClass(a.target, "highcharts-tracker") ? (y(f.series, "click", z(a, {
                    point: f
                })),
                b.hoverPoint && f.firePointEvent("click", a)) : (z(a, this.getCoordinates(a)),
                b.isInsidePlot(a.chartX - c, a.chartY - e) && y(b, "click", a)))
            },
    ...
    (function(a) {
        ...
        G(a.Pointer.prototype, {
            ...
            pinchTranslateDirection: function(a, g, m, p, l, b, e, t) {
                var n = this.chart, f = a ? "x" : "y", c = a ? "X" : "Y", h = "chart" + c, w = a ? "width" : "height", D = n["plot" + (a ? "Left" : "Top")], r, J, q = t || 1, F = n.inverted, x = n.bounds[a ? "h" : "v"], K = 1 === g.length, d = g[0][h], H = m[0][h], E = !K && g[1][h], k = !K && m[1][h], A;
                m = function() {
            ...
            touch: function(m, p) {
                ...
                (l = u.isInsidePlot(m.chartX - u.plotLeft, m.chartY - u.plotTop)) && !u.openMenu ? (p && this.runPointActions(m),
                "touchmove" === m.type && (p = this.pinchDown,
                v = p[0] ? 4 <= Math.sqrt(Math.pow(p[0].chartX - m.chartX, 2) + Math.pow(p[0].chartY - m.chartY, 2)) : !1),
                g(v, !0) && this.pinch(m)) : p && this.reset()) : 2 === m.touches.length && this.pinch(m)
            },
    ...
    (function(a) {
        ...
        if (!a.hasTouch && (u.PointerEvent || u.MSPointerEvent)) {
            var l = {}
              ...
              , t = function(b, f, c, h) {
                "touch" !== b.pointerType && b.pointerType !== b.MSPOINTER_TYPE_TOUCH || !C[a.hoverChartIndex] || (h(b),
                h = C[a.hoverChartIndex].pointer,
                h[f]({
                    type: c,
    ...
    (function(a) {
        ...
        a.Legend.prototype = {
            ...
            colorizeItem: function(a, b) {
                ...
                n && (q && n.isMarker && (F = a.pointAttribs(),
                b || (F.stroke = F.fill = l)),
                n.attr(F));
            ...
            positionCheckboxes: function() {
                ...
                a && (b = a.translateY,
                m(this.allItems, function(f) {
                    var e = f.checkbox, n;
                    e && (n = b + h + e.y + (this.scrollOffset || 0) + 3,
                    C(e, {
            ...
            renderItem: function(a) {
                ...
                this.baseline || (e = n.fontSize,
                this.fontMetrics = c.fontMetrics(e, x),
                ...
                this.setItemEvents && this.setItemEvents(a, x, E),
                H && this.createCheckboxForItem(a));
                this.colorizeItem(a, a.visible);
                n.width || x.css({
                    width: (h.itemWidth || h.width || b.spacingBox.width) - q
                });
                this.setText(a);
                b = x.getBBox();
            ...
            layoutItem: function(a) {
                var b = this.options
                  ...
                  , q = b.width
                  , g = q || this.chart.spacingBox.width - 2 * c - b.x
                  , b = b.alignColumns && this.totalItemWidth > g ? this.maxItemWidth : a.itemWidth;
                h && this.itemX - c + b > g && (this.itemX = c,
                this.itemY += n + this.lastLineHeight + l,
                this.lastLineHeight = 0);
                this.lastItemY = n + this.itemY + l;
                this.lastLineHeight = Math.max(e, this.lastLineHeight);
                a._legendItemPos = [this.itemX, this.itemY];
                h ? this.itemX += b : (this.itemY += n + e + l,
            ...
            adjustMargins: function(a, b) {
                ...
                e && m([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(h, l) {
                    h.test(e) && !p(a[l]) && (c[z[l]] = Math.max(c[z[l]], c.legend[(l + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][l] * f[l % 2 ? "x" : "y"] + y(f.margin, 12) + b[l] + (0 === l && void 0 !== c.options.title.margin ? c.titleOffset + c.options.title.margin : 0)))
                })
            },
            render: function() {
                var a = this.chart, f = a.renderer, c = this.group, e, l, t, r, g = this.box, q = this.options, F = this.padding;
                this.itemX = F;
                ...
                this.contentGroup = f.g().attr({
                    zIndex: 1
                }).add(c),
                this.scrollGroup = f.g().add(this.contentGroup));
                this.renderTitle();
                e = this.getAllItems();
                b(e, function(a, b) {
                ...
                l && (f = a.spacingBox,
                /(lth|ct|rth)/.test(this.getAlignment()) && (f = u(f, {
            ...
            handleOverflow: function(a) {
                var b = this, c = this.chart, e = c.renderer, l = this.options, n = l.y, r = this.padding, c = c.spacingBox.height + ("top" === l.verticalAlign ? -n : n) - r, n = l.maxHeight, t, q = this.clipRect, g = l.navigation, x = y(g.animation, !0), K = g.arrowSize || 12, d = this.nav, H = this.pages, E, k = this.allItems, A = function(a) {
                ...
                n && (c = Math.min(c, n));
                H.length = 0;
                a > c && !1 !== g.enabled ? (this.clipHeight = t = Math.max(c - 20 - this.titleHeight - r, 0),
                ...
                m(k, function(a, b) {
                    var d = a._legendItemPos[1]
                      ...
                      , f = H.length;
                    if (!f || d - H[f - 1] > t && (E || d) !== H[f - 1])
                        H.push(E || d),
                        f++;
                    a.pageIx = f - 1;
                    E && (k[b - 1].pageIx = f - 1);
                    b === k.length - 1 && d + c - H[f - 1] > t && (H.push(d),
                    a.pageIx = f);
                    d !== E && (E = d)
                }),
                q || (q = b.clipRect = e.clipRect(0, r, 9999, 0),
                b.contentGroup.clip(q)),
                A(t),
                d || (this.nav = d = e.g().attr({
                    zIndex: 1
                }).add(this.group),
                this.up = e.symbol("triangle", 0, 0, K, K).on("click", function() {
                    b.scroll(-1, x)
                }).add(d),
                this.pager = e.text("", 15, 10).addClass("highcharts-legend-navigation").css(g.style).add(d),
                this.down = e.symbol("triangle-down", 0, 0, K, K).on("click", function() {
                    b.scroll(1, x)
                }).add(d)),
                b.scroll(0),
                a = c) : d && (A(),
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function(a, b) {
                ...
                b.legendSymbol = this.chart.renderer.rect(f ? (a.symbolWidth - c) / 2 : 0, a.baseline - c + 1, f ? c : a.symbolWidth, c, y(a.options.symbolRadius, c / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(b.legendGroup)
            },
            drawLineMarker: function(a) {
                ...
                c && !1 !== c.enabled && (b = Math.min(y(c.radius, n), n),
                0 === this.symbol.indexOf("url") && (c = u(c, {
                    width: l,
                    height: l
                }),
                b = 0),
                this.legendSymbol = c = r.symbol(this.symbol, e / 2 - b, a - b, 2 * b, 2 * b, c).addClass("highcharts-point").add(t),
                c.isMarker = !0)
            }
        };
    ...
    (function(a) {
        ...
        t(R.prototype, {
            ...
            init: function(b, d) {
                var k, c, e = b.series, h = b.plotOptions || {};
                f(this, "init", {
                    args: arguments
                }, function() {
                    b.series = null;
                    k = q(z, b);
                    for (c in k.plotOptions)
                        k.plotOptions[c].tooltip = h[c] && q(h[c].tooltip) || void 0;
            ...
            redraw: function(b) {
                f(this, "beforeRedraw");
                var d = this.axes, k = this.series, c = this.pointer, h = this.legend, x = this.isDirtyLegend, l, q, E = this.hasCartesianSeries, r = this.isDirtyBox, n, H = this.renderer, g = H.isHidden(), A = [];
            ...
            layOutTitles: function(a) {
                ...
                e(["title", "subtitle"], function(a) {
                    ...
                    var e;
                    d && (e = f.style.fontSize,
                    e = k.fontMetrics(e, d).b,
                    d.css({
                        width: (f.width || c.width + f.widthAdjust) + "px"
                    }).align(t({
                        y: a + e
                    }, f), !1, "spacingBox"),
                    f.floating || f.verticalAlign || (b = Math.ceil(b + d.getBBox(f.useHTML).height)))
                }, this);
                d = this.titleOffset !== b;
                this.titleOffset = b;
                !this.isDirtyBox && d && (this.isDirtyBox = this.isDirtyLegend = d,
            ...
            temporaryDisplay: function(b) {
                ...
                if (b)
                    for (; d && d.style; )
                        ...
                        d.hcOrigDetached && (m.body.removeChild(d),
                        d.hcOrigDetached = !1),
                        d = d.parentNode;
                else
                    for (; d && d.style; ) {
                        m.body.contains(d) || d.parentNode || (d.hcOrigDetached = !0,
                        m.body.appendChild(d));
                        if ("none" === a.getStyle(d, "display", !1) || d.hcOricDetached)
                            d.hcOrigStyle = {
            ...
            getMargins: function(a) {
                var d = this.spacing
                  ...
                  , c = this.titleOffset;
                this.resetMargins();
                c && !b(k[0]) && (this.plotTop = Math.max(this.plotTop, c + this.options.title.margin + d[0]));
            ...
            reflow: function(d) {
                ...
                if (!e && !k.isPrinting && h && c && (f === P || f === m)) {
                    if (h !== k.containerWidth || c !== k.containerHeight)
                        a.clearTimeout(k.reflowTimeout),
                        k.reflowTimeout = A(function() {
            ...
            setReflow: function(a) {
                var b = this;
                !1 === a || this.unbindReflow ? !1 === a && this.unbindReflow && (this.unbindReflow = this.unbindReflow()) : (this.unbindReflow = B(P, "resize", function(a) {
                    b.reflow(a)
                }),
            ...
            setSize: function(b, d, k) {
                ...
                c.setChartSize(!0);
                h.setSize(c.chartWidth, c.chartHeight, k);
                e(c.axes, function(a) {
                    a.isDirty = !0;
                    a.setScale()
                });
            ...
            setChartSize: function(a) {
                var b = this.inverted, d = this.renderer, c = this.chartWidth, k = this.chartHeight, h = this.options.chart, x = this.spacing, l = this.clipOffset, q, E, r, n;
                ...
                this.clipBox = {
                    x: b,
                    y: d,
                    width: Math.floor(this.plotSizeX - Math.max(c, l[1]) / 2 - b),
            ...
            propFromSeries: function() {
                ...
                e(["inverted", "angular", "polar"], function(e) {
                    ...
                    for (k = c && c.length; !f && k--; )
                        (d = E[c[k].type]) && d.prototype[e] && (f = !0);
                    a[e] = f
                })
            },
            linkSeries: function() {
                ...
                e(b, function(b) {
                    ...
                    D(d) && (d = ":previous" === d ? a.series[b.index - 1] : a.get(d)) && d.linkedParent !== b && (d.linkedSeries.push(b),
                    b.linkedParent = d,
                    b.visible = K(b.options.visible, d.options.visible, b.visible))
                });
    ...
    (function(a) {
        ...
        B(C, "afterSetChartSize", function(p) {
            ...
            if (m = m && m.minWidth)
                if (this.scrollablePixels = m = Math.max(0, m - this.chartWidth))
                    this.plotWidth += m,
                    this.clipBox.width += m,
                    p.skipAxes || G(this.axes, function(g) {
        ...
        C.prototype.applyFixed = function() {
            ...
            this.scrollableMask = m.path().attr({
                fill: a.color(this.options.chart.backgroundColor || "#fff").setOpacity(.85).get(),
                zIndex: -1
            }).addClass("highcharts-scrollable-mask").add(),
            a.each([this.inverted ? ".highcharts-xaxis" : ".highcharts-yaxis", this.inverted ? ".highcharts-xaxis-labels" : ".highcharts-yaxis-labels", ".highcharts-contextbutton", ".highcharts-credits", ".highcharts-legend", ".highcharts-subtitle", ".highcharts-title"], function(g) {
    ...
    (function(a) {
        var B, C = a.each, G = a.extend, p = a.erase, m = a.fireEvent, g = a.format, v = a.isArray, z = a.isNumber, u = a.pick, y = a.removeEvent;
        a.Point = B = function() {}
        ;
        a.Point.prototype = {
            init: function(a, b, e) {
                ...
                e = a.colorCounter,
                a.colorCounter++,
                a.colorCounter === b && (a.colorCounter = 0)) : e = a.colorIndex;
            ...
            optionsToObject: function(l) {
                ...
                if (z(l) || null === l)
                    ...
                    for (!t && l.length > f && (e = typeof l[0],
                    "string" === e ? b.name = l[0] : "number" === e && (b.x = l[0]),
                    c++); h < f; )
                        t && void 0 === l[c] || (0 < n[h].indexOf(".") ? a.Point.prototype.setNestedProperty(b, l[c], n[h]) : b[n[h]] = l[c]),
                        c++,
                        h++;
                else
                    "object" === typeof l && (b = l,
                    l.dataLabels && (e._hasPointLabels = !0),
                    l.marker && (e._hasPointMarkers = !0));
                return b
            },
            ...
            destroyElements: function() {
                for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], b, e = 6; e--; )
                    b = a[e],
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            autoIncrement: function() {
                var a = this.options, b = this.xIncrement, d, c = a.pointIntervalUnit, f = this.chart.time, b = w(b, a.pointStart, 0);
            ...
            setOptions: function(a) {
                ...
                this.stickyTracking = w(a.stickyTracking, h[this.type] && h[this.type].stickyTracking, h.series && h.series.stickyTracking, this.tooltipOptions.shared && !this.noSharedTooltip ? !0 : f.stickyTracking);
            ...
            getCyclic: function(a, b, d) {
                var c, f = this.chart, k = this.userOptions, e = a + "Index", h = a + "Counter", x = d ? d.length : w(f.options.chart[a + "Count"], f[a + "Count"]);
                b || (c = w(k[e], k["_" + e]),
                z(c) || (f.series.length || (f[h] = 0),
                k["_" + e] = c = f[h] % x,
                f[h] += 1),
                d && (b = d[c]));
                void 0 !== c && (this[e] = c);
            ...
            updateData: function(b) {
                ...
                u(b, function(b) {
                    ...
                    n(k) && (k = a.inArray(k, this.xData, h),
                    -1 === k ? f.push(b) : b !== c.data[k] ? (d[k].update(b, !1, null, !1),
                    d[k].touched = !0,
                    x && (h = k)) : d[k] && (d[k].touched = !0),
                    e = !0)
                }, this);
                if (e)
                    for (b = d.length; b--; )
                        k = d[b],
                        k.touched || k.remove(!1),
                        k.touched = !1;
            ...
            setData: function(b, c, d, e) {
                var h = this, k = h.points, x = k && k.length || 0, q, l = h.options, r = h.chart, g = null, H = h.xAxis, F = l.turboThreshold, m = this.xData, D = this.yData, K = (q = h.pointArrayMap) && q.length, J;
                b = b || [];
                q = b.length;
                c = w(c, !0);
                ...
                if (!J) {
                    ...
                    if (F && q > F) {
                        ...
                        for (d = 0; d < q; d++)
                            ...
                            h.pointClass.prototype.applyOptions.apply(g, [b[d]]),
                            h.updateParallelArrays(g, d));
            ...
            processData: function(b) {
                ...
                q = l.cropThreshold;
                var r = this.getExtremesFromAll || l.getExtremesFromAll, n = this.isCartesian, l = x && x.val2lin, g = x && x.isLog, t = this.requireSorting, w, F;
                if (n && !this.isDirty && !x.isDirty && !this.yAxis.isDirty && !b)
                    return !1;
                x && (b = x.getExtremes(),
                w = b.min,
                F = b.max);
                if (n && this.sorted && !r && (!q || f > q || this.forceCrop))
                    if (c[f - 1] < w || c[0] > F)
                        c = [],
                        d = [];
                    else if (c[0] < w || c[f - 1] > F)
                        e = this.cropData(this.xData, this.yData, w, F),
                        c = e.xData,
                        d = e.yData,
                        e = e.start,
                        k = !0;
                for (q = c.length || 1; --q; )
                    f = g ? l(c[q]) - l(c[q - 1]) : c[q] - c[q - 1],
                    0 < f && (void 0 === h || f < h) ? h = f : 0 > f && t && (a.error(15),
                    t = !1);
                this.cropped = k;
                this.cropStart = e;
            ...
            generatePoints: function() {
                var a = this.options, b = a.data, d = this.data, c, f = this.processedXData, k = this.processedYData, e = this.pointClass, h = f.length, q = this.cropStart || 0, l, n = this.hasGroupedData, a = a.keys, g, t = [], w;
                d || n || (d = [],
                d.length = b.length,
                d = this.data = d);
                ...
                for (w = 0; w < h; w++)
                    l = q + w,
                    n ? (g = (new e).init(this, [f[w]].concat(r(k[w]))),
                    g.dataGroup = this.groupMap[w]) : (g = d[l]) || void 0 === b[l] || (d[l] = g = (new e).init(this, b[l], f[w])),
                    g && (g.index = l,
                    t[w] = g);
                this.options.keys = a;
                if (d && (h !== (c = d.length) || n))
            ...
            getExtremes: function(a) {
                ...
                for (g = 0; g < c; g++)
                    if (x = d[g],
                    r = a[g],
                    q = (n(r, !0) || t(r)) && (!b.positiveValuesOnly || r.length || 0 < r),
                    x = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[g + l] || x) >= e && (d[g - l] || x) <= h,
                    q && x)
                        if (q = r.length)
                            for (; q--; )
                                "number" === typeof r[q] && (f[k++] = r[q]);
                        else
                            f[k++] = r;
                this.dataMin = p(f);
                this.dataMax = G(f)
            ...
            translate: function() {
                ...
                this.generatePoints();
                var a = this.options, c = a.stacking, d = this.xAxis, f = d.categories, e = this.yAxis, k = this.points, h = k.length, q = !!this.modifyValue, l = a.pointPlacement, r = "between" === l || n(l), g = a.threshold, t = a.startFromThreshold ? g : 0, F, D, J, u, v = Number.MAX_VALUE;
                "between" === l && (l = .5);
                ...
                for (a = 0; a < h; a++) {
                    ...
                    c && this.visible && !p.isNull && B && B[y] && (u = this.getStackIndicator(u, y, this.index),
                    G = B[y],
                    C = G.points[u.key],
                    D = C[0],
                    C = C[1],
                    D === t && u.key === B[y].base && (D = w(n(g) && g, e.min)),
                    e.positiveValuesOnly && 0 >= D && (D = null),
                    p.total = p.stackTotal = G.total,
                    p.percentage = G.total && p.y / G.total * 100,
                    p.stackY = C,
                    ...
                    p.clientX = r ? m(d.translate(y, 0, 0, 0, 1, l)) : F;
                    p.negative = p.y < (g || 0);
                    p.category = f && void 0 !== f[p.x] ? f[p.x] : p.x;
                    p.isNull || (void 0 !== J && (v = Math.min(v, Math.abs(F - J))),
                    J = F);
            ...
            setClip: function(a) {
                ...
                q || (a && (e.width = 0,
                f && (e.x = b.plotSizeX),
                b[h + "m"] = l = c.clipRect(f ? b.plotSizeX + 99 : -99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)),
                b[h] = q = c.clipRect(e),
                q.count = {
                    length: 0
                });
            ...
            drawPoints: function() {
                var a = this.points, b = this.chart, d, c, f, k, e = this.options.marker, h, q, l, r = this[this.specialGroup] || this.markerGroup, g, n = w(e.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= e.enabledThreshold * e.radius);
                if (!1 !== e.enabled || this._hasPointMarkers)
                    for (d = 0; d < a.length; d++)
                        ...
                        h = c.marker || {},
                        q = !!c.marker,
                        f = n && void 0 === h.enabled || h.enabled,
                        l = c.isInside,
                        f && !c.isNull ? (f = w(h.symbol, this.symbol),
                        g = this.markerAttribs(c, c.selected && "select"),
                        k ? k[l ? "show" : "hide"](!0).animate(g) : l && (0 < g.width || c.hasImage) && (c.graphic = k = b.renderer.symbol(f, g.x, g.y, g.width, g.height, q ? h : e).add(r)),
                        k && k.attr(this.pointAttribs(c, c.selected && "select")),
                        k && k.addClass(c.getClassName(), !0)) : k && (c.graphic = k.destroy())
            },
            markerAttribs: function(a, b) {
                ...
                k = w(b && b.radius, d && d.radius, k + (d && d.radiusPlus || 0)));
            ...
            pointAttribs: function(a, b) {
                ...
                c = w(b.lineWidth, d.lineWidth, c + w(b.lineWidthPlus, d.lineWidthPlus, 0)),
            ...
            destroy: function() {
                var c = this, f = c.chart, d = /AppleWebKit\/533/.test(F.navigator.userAgent), e, q, k = c.data || [], l, r;
                b(c, "destroy");
                D(c);
                u(c.axisTypes || [], function(a) {
                    (r = c[a]) && r.series && (y(r.series, c),
                    r.isDirty = r.forceRedraw = !0)
                });
                c.legendItem && c.chart.legend.destroyItem(c);
                for (q = k.length; q--; )
                    (l = k[q]) && l.destroy && l.destroy();
                c.points = null;
                a.clearTimeout(c.animationTimeout);
                h(c, function(a, b) {
                    a instanceof J && !a.survive && (e = d && "group" === b ? "hide" : "destroy",
                    a[e]())
                });
            ...
            getGraphPath: function(a, b, d) {
                ...
                u(a, function(e, r) {
                    ...
                    e.isNull && !z(b) && 0 < r ? l = !f.connectNulls : e.isNull && !b ? l = !0 : (0 === r || l ? r = ["M", e.plotX, e.plotY] : c.getPointSpline ? r = c.getPointSpline(a, e, r) : k ? (r = 1 === k ? ["L", n.plotX, g] : 2 === k ? ["L", (n.plotX + x) / 2, n.plotY, "L", (n.plotX + x) / 2, g] : ["L", x, n.plotY],
                    r.push("L", x, g)) : r = ["L", x, g],
                    q.push(e.x),
                    k && (q.push(e.x),
                    2 === k && q.push(e.x)),
                    h.push.apply(h, r),
            ...
            drawGraph: function() {
                ...
                u(c, function(c, f) {
                    var k = c[0]
                      , e = a[k];
                    e ? (e.endX = a.preventGraphAnimation ? null : d.xMap,
                    e.animate({
                        d: d
                    ...
                    e = a[k].attr(e).shadow(2 > f && b.shadow));
                    e && (e.startX = d.xMap,
                    e.isArea = d.isArea)
                })
            },
            ...
            applyZones: function() {
                var a = this, b = this.chart, d = b.renderer, c = this.zones, f, k, e = this.clips || [], h, q = this.graph, l = this.area, r = Math.max(b.chartWidth, b.chartHeight), g = this[(this.zoneAxis || "y") + "Axis"], n, t, F = b.inverted, D, m, J, p, v = !1;
                c.length && (q || l) && g && void 0 !== g.min && (t = g.reversed,
                D = g.horiz,
                q && !this.showLine && q.hide(),
                l && l.hide(),
                n = g.getExtremes(),
                u(c, function(c, x) {
                    ...
                    e[x] ? e[x].animate(h) : (e[x] = d.clipRect(h),
                    q && a["zone-graph-" + x].clip(e[x]),
                    l && a["zone-area-" + x].clip(e[x]));
                    v = c.value > n.max;
            ...
            render: function() {
                var a = this, c = a.chart, d, f = a.options, e = !!a.animate && c.renderer.isSVG && C(f.animation).duration, k = a.visible ? "inherit" : "hidden", h = f.zIndex, l = a.hasRendered, r = c.seriesGroup, g = c.inverted;
            ...
            searchKDTree: function(a, b) {
                function d(a, b, h, q) {
                    ...
                    b[g] && (g = d(a, b[g], h + 1, q),
                    t = g[e] < t[e] ? g : l);
                    b[n] && Math.sqrt(r * r) < t[e] && (a = d(a, b[n], h + 1, q),
                    t = a[e] < t[e] ? a : t);
                    return t
                }
                var c = this
    ...
    (function(a) {
        ...
        a.StackItem.prototype = {
            ...
            setOffset: function(a, b) {
                ...
                if (b = this.label)
                    b.align(this.alignOptions, null, e),
                    e = b.alignAttr,
                    b[!1 === this.options.crop || l.isInsidePlot(e.x, e.y) ? "show" : "hide"](!0)
            },
        ...
        y.prototype.setStackedPoints = function() {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var l = this.processedXData, b = this.processedYData, e = [], g = b.length, n = this.options, f = n.threshold, c = u(n.startFromThreshold && f, 0), h = n.stack, n = n.stacking, w = this.stackKey, D = "-" + w, r = this.negStacks, m = this.yAxis, q = m.stacks, F = m.oldStacks, x, v, d, H, E, k, A;
                m.stacksTouched += 1;
                for (E = 0; E < g; E++)
                    k = l[E],
                    A = b[E],
                    x = this.getStackIndicator(x, k, this.index),
                    H = x.key,
                    d = (v = r && A < (c ? 0 : f)) ? D : w,
                    q[d] || (q[d] = {}),
                    q[d][k] || (F[d] && F[d][k] ? (q[d][k] = F[d][k],
                    q[d][k].total = null) : q[d][k] = new a.StackItem(m,m.options.stackLabels,v,k,h)),
                    d = q[d][k],
                    null !== A ? (d.points[H] = d.points[this.index] = [u(d.cumulative, c)],
                    p(d.cumulative) || (d.base = H),
                    d.touched = m.stacksTouched,
                    0 < x.index && !1 === this.singleStacks && (d.points[H][0] = d.points[this.index + "," + k + ",0"][0])) : d.points[H] = d.points[this.index] = null,
                    "percent" === n ? (v = v ? w : D,
                    r && q[v] && q[v][k] ? (v = q[v][k],
                    d.total = v.total = Math.max(v.total, d.total) + Math.abs(A) || 0) : d.total = G(d.total + (Math.abs(A) || 0))) : d.total = G(d.total + (A || 0)),
                    d.cumulative = u(d.cumulative, c) + (A || 0),
                    null !== A && (d.points[H].push(d.cumulative),
                    e[E] = d.cumulative);
        ...
        y.prototype.modifyStacks = function() {
            var a = this, b = a.stackKey, e = a.yAxis.stacks, t = a.processedXData, n, f = a.options.stacking;
            a[f + "Stacker"] && g([b, "-" + b], function(b) {
                for (var c = t.length, l, g; c--; )
                    if (l = t[c],
                    n = a.getStackIndicator(n, l, a.index, b),
                    g = (l = e[b] && e[b][l]) && l.points[n.key])
                        a[f + "Stacker"](g, l, c)
            })
        }
        ;
    ...
    (function(a) {
        ...
        u(a.Chart.prototype, {
            ...
            update: function(a, e, h, r) {
                ...
                a.plotOptions && n(!0, this.options.plotOptions, a.plotOptions);
                f(a, function(a, b) {
                    if (d[b] && "function" === typeof d[b].update)
                        d[b].update(a, !1);
                    else if ("function" === typeof d[q[b]])
                        d[q[b]](a);
                ...
                v("xAxis yAxis zAxis series colorAxis pane".split(" "), function(b) {
                    a[b] && (v(J(a[b]), function(a, c) {
                        (c = g(a.id) && d.get(a.id) || d[b][c]) && c.coll === b && (c.update(a, !1),
                        h && (c.touched = !0));
                        if (!c && h)
                            if ("series" === b)
                                d.addSeries(a, !1).touched = !0;
                            else if ("xAxis" === b || "yAxis" === b)
                                d.addAxis(a, "xAxis" === b, !1).touched = !0
                    }),
                    h && v(d[b], function(a) {
        ...
        u(h.prototype, {
            update: function(a, b, f, h) {
                function d() {
                    q.applyOptions(a);
                    null === q.y && k && (q.graphic = k.destroy());
                    e(a, !0) && (k && k.element && a && a.marker && void 0 !== a.marker.symbol && (q.graphic = k.destroy()),
                    a && a.dataLabels && q.dataLabel && (q.dataLabel = q.dataLabel.destroy()),
                    q.connector && (q.connector = q.connector.destroy()));
                    g = q.index;
                ...
                var q = this, l = q.series, k = q.graphic, g, r = l.chart, n = l.options;
                b = c(b, !0);
        ...
        u(w.prototype, {
            addPoint: function(a, b, f, e) {
                var d = this.options, h = this.data, q = this.chart, k = this.xAxis, k = k && k.hasNames && k.names, l = d.data, g, r, n = this.xData, x, t;
                b = c(b, !0);
                g = {
                    series: this
                };
                ...
                if (this.requireSorting && t < n[x - 1])
                    for (r = !0; x && n[x - 1] > t; )
                        x--;
                this.updateParallelArrays(g, "splice", x, 0, 0);
                this.updateParallelArrays(g, x);
                k && g.name && (k[t] = g.name);
                l.splice(x, 0, a);
                r && (this.data.splice(x, 0, null),
                this.processData());
            ...
            update: function(b, f) {
                var e = this, h = e.chart, d = e.userOptions, q = e.oldType || e.type, g = b.type || d.type || h.options.chart.type, k = D[q].prototype, r, t = ["group", "markerGroup", "dataLabelsGroup"], w = ["navigatorSeries", "baseSeries"], m = e.finishedAnimating && {
                    animation: !1
                }, F = ["data", "name", "turboThreshold"], J = a.keys(b), p = 0 < J.length;
                v(J, function(a) {
                    -1 === l(a, F) && (p = !1)
                });
                if (p)
                    ...
                    e.init(h, b);
                    b.zIndex !== d.zIndex && v(t, function(a) {
                        e[a] && e[a].attr({
                            zIndex: b.zIndex
                        })
                    });
        ...
        u(G.prototype, {
            ...
            remove: function(a) {
                for (var b = this.chart, f = this.coll, e = this.series, d = e.length; d--; )
                    e[d] && e[d].remove(!1);
                z(b.axes, this);
                z(b[f], this);
    ...
    (function(a) {
        ...
        g("area", "line", {
            ...
            getStackPoints: function(g) {
                var m = [], u = [], v = this.xAxis, l = this.yAxis, b = l.stacks[this.stackKey], e = {}, t = this.index, n = l.series, f = n.length, c, h = p(l.options.reversedStacks, !0) ? 1 : -1, w;
                g = g || this.points;
                if (this.options.stacking) {
                    for (w = 0; w < g.length; w++)
                        g[w].leftNull = g[w].rightNull = null,
                        e[g[w].x] = g[w];
                    a.objectEach(b, function(a, b) {
                        ...
                        if (e[a] && !e[a].isNull)
                            ...
                            C([-1, 1], function(l) {
                                ...
                                if (x)
                                    for (w = t; 0 <= w && w < f; )
                                        q = x.points[w],
                                        q || (w === t ? e[a][r] = !0 : c[w] && (n = b[a].points[w]) && (d -= n[1] - n[0])),
                                        w += h;
            ...
            getGraphPath: function(a) {
                var g = m.prototype.getGraphPath, u = this.options, v = u.stacking, l = this.yAxis, b, e, t = [], n = [], f = this.index, c, h = l.stacks[this.stackKey], w = u.threshold, D = l.getThreshold(u.threshold), r, u = u.connectNulls || "percent" === v, J = function(b, e, g) {
                    var q = a[b];
                    b = v && h[q.x].points[f];
                    var d = q[g + "Null"] || 0;
                    g = q[g + "Cliff"] || 0;
            ...
            drawGraph: function() {
                ...
                C(y, function(l) {
                    var b = l[0]
                      , e = a[b];
                    e ? (e.endX = a.preventGraphAnimation ? null : g.xMap,
                    e.animate({
                        d: g
        ...
        a("spline", "line", {}, {
            getPointSpline: function(a, G, p) {
                ...
                if (v && !v.isNull && !1 !== v.doCurve && !G.isCliff && p && !p.isNull && !1 !== p.doCurve && !G.isCliff) {
                    ...
                    u += b;
                    l += b;
                    u > a && u > g ? (u = Math.max(a, g),
                    l = 2 * g - u) : u < a && u < g && (u = Math.min(a, g),
                    l = 2 * g - u);
                    l > p && l > g ? (l = Math.max(p, g),
                    u = 2 * g - l) : l < p && l < g && (l = Math.min(p, g),
                    u = 2 * g - l);
                    G.rightContX = y;
                    G.rightContY = l
                }
        ...
        u("column", "line", {
            ...
            getColumnMetrics: function() {
                ...
                !1 === b.grouping ? h = 1 : G(a.chart.series, function(b) {
                    ...
                    b.type !== a.type || !b.visible && a.chart.options.chart.ignoreHiddenSeries || g.len !== l.len || g.pos !== l.pos || (e.stacking ? (f = b.stackKey,
                    void 0 === c[f] && (c[f] = h++),
                    r = c[f]) : !1 !== e.grouping && (r = h++),
                    b.columnIndex = r)
                });
            ...
            crispCol: function(a, b, e, g) {
                ...
                this.options.crisp && (e = Math.round(a + e) + c,
                a = Math.round(a) + c,
                e -= a);
                g = Math.round(b + g) + f;
                c = .5 >= Math.abs(b) && .5 < g;
            ...
            translate: function() {
                ...
                G(a.points, function(e) {
                    var g = v(e.yBottom, c), q = 999 + Math.abs(g), q = Math.min(Math.max(-q, e.plotY), n.len + q), l = e.plotX + J, d = r, t = Math.min(q, g), w, k = Math.max(q, g) - t;
                    h && Math.abs(k) < h && (k = h,
                    w = !n.reversed && !e.negative || n.reversed && e.negative,
                    e.y === f && a.dataMax <= f && n.min < f && (w = !w),
                    t = Math.abs(t - c) > h ? g - h : c - (w ? h : 0));
                    e.barX = l;
                    e.pointWidth = m;
                    e.tooltipPos = b.inverted ? [n.len + n.pos - b.plotLeft - q, a.xAxis.len - l - d / 2, k] : [l + d / 2, q + n.pos - b.plotTop, k];
                    e.shapeType = "rect";
                    e.shapeArgs = a.crispCol.apply(a, e.isNull ? [l, c, d, 0] : [l, t, d, k])
                })
            },
            getSymbol: a.noop,
            drawLegendSymbol: a.LegendSymbolMixin.drawRectangle,
            ...
            pointAttribs: function(a, b) {
                ...
                b = a.brightness,
                c = a.color || void 0 !== b && C(c).brighten(a.brightness).get() || c,
                h = a[l] || h,
                w = a[f] || w,
                n = a.dashStyle || n);
                l = {
                ...
                G(a.points, function(c) {
                    ...
                    if (m(c.plotY) && null !== c.y) {
                        ...
                        if (h)
                            ...
                            c.graphic = h = t[c.shapeType](f).add(c.group || a.group);
            ...
            animate: function(a) {
                var b = this, e = this.yAxis, g = b.options, l = this.chart.inverted, f = {}, c = l ? "translateX" : "translateY", h;
                y && (a ? (f.scaleY = .001,
                a = Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(g.threshold))),
                l ? f.translateX = a - e.len : f.translateY = a,
                b.group.attr(f)) : (h = b.group.attr(c),
                b.group.animate({
                    scaleY: 1
    ...
    (function(a) {
        ...
        a.CenteredSeriesMixin = {
            getCenter: function() {
                var a = this.options, g = this.chart, v = 2 * (a.slicedOffset || 0), z = g.plotWidth - 2 * v, g = g.plotHeight - 2 * v, u = a.center, u = [G(u[0], "50%"), G(u[1], "50%"), a.size || "100%", a.innerSize || 0], y = Math.min(z, g), l, b;
                for (l = 0; 4 > l; ++l)
                    b = u[l],
                    a = 2 > l || 2 === l && /%$/.test(b),
                    u[l] = p(b, [z, g, y, u[2]][l]) + (a ? v : 0);
                u[3] > u[2] && (u[3] = u[2]);
                return u
            },
    ...
    (function(a) {
        ...
        b("pie", "line", {
            ...
            updateTotals: function() {
                ...
                for (a = 0; a < c; a++)
                    e = f[a],
                    b += g && !e.visible ? 0 : e.isNull ? 0 : e.y;
                this.total = b;
                for (a = 0; a < c; a++)
                    e = f[a],
                    e.percentage = 0 < b && (e.visible || !g) ? e.y / b * 100 : 0,
                    e.total = b
            },
            generatePoints: function() {
            ...
            translate: function(a) {
                this.generatePoints();
                var b = 0, f = this.options, c = f.slicedOffset, e = c + (f.borderWidth || 0), l, m, r, t = g(f.startAngle, f.endAngle), q = this.startAngleRad = t.start, t = (this.endAngleRad = t.end) - q, F = this.points, x, p = f.dataLabels.distance, f = f.ignoreHiddenPoint, d, H = F.length, E;
                a || (this.center = a = this.getCenter());
                this.getX = function(b, d, c) {
                    r = Math.asin(Math.min((b - a[1]) / (a[2] / 2 + c.labelDistance), 1));
            ...
            drawGraph: null,
            drawPoints: function() {
                var a = this, b = a.chart.renderer, f, c, e, g, l = a.options.shadow;
                l && !a.shadowGroup && (a.shadowGroup = b.g("shadow").add(a.group));
                p(a.points, function(h) {
                    c = h.graphic;
                    if (h.isNull)
                        c && (h.graphic = c.destroy());
                    else {
                        g = h.shapeArgs;
                        f = h.getTranslate();
                        var r = h.shadowGroup;
                        ...
                        c ? c.setRadialReference(a.center).attr(e).animate(m(g, f)) : (h.graphic = c = b[h.shapeType](g).setRadialReference(a.center).attr(f).add(a.group),
                        h.visible || c.attr({
                            visibility: "hidden"
                        }),
                        c.attr(e).attr({
            ...
            setVisible: function(a, b) {
                ...
                b = u(b, g);
                a !== f.visible && (f.visible = f.options.visible = a = void 0 === a ? !f.visible : a,
                c.options.data[v(f, c.data)] = f.options,
                p(["graphic", "dataLabel", "connector", "shadowGroup"], function(b) {
                    if (f[b])
                        f[b][a ? "show" : "hide"](!0)
                }),
                f.legendItem && e.legend.colorizeItem(f, a),
                a || "hover" !== f.state || f.setState(""),
                g && (c.isDirty = !0),
                b && e.redraw())
            },
    ...
    (function(a) {
        ...
        a.distribute = function(b, c, e) {
            ...
            for (b = v(b, function(a) {
                ...
                for (h = b.length; h--; )
                    ...
                    g.pos = Math.min(Math.max(0, m - g.size * g.align), c - g.size);
                h = b.length;
                for (g = !1; h--; )
                    0 < h && b[h - 1].pos + b[h - 1].size > b[h].pos && (b[h - 1].size += b[h].size,
                    b[h - 1].targets = b[h - 1].targets.concat(b[h].targets),
                    b[h - 1].align = .5,
                    b[h - 1].pos + b[h - 1].size > c && (b[h - 1].pos = c - b[h - 1].size),
                    b.splice(h, 1),
                    g = !0)
            }
            l.push.apply(l, q);
            ...
            t(b, function(b) {
                ...
                if (t(b.targets, function() {
                    l[h].pos = b.pos + d;
                    if (Math.abs(l[h].pos - l[h].target) > e)
                        return p(l.slice(0, h + 1), function(a) {
                            delete a.pos
                        }),
                        l.reducedLen = (l.reducedLen || c) - .1 * c,
                        l.reducedLen > .1 * c && a.distribute(l, c, e),
                        !0;
                    d += l[h].size;
                    h++
                }))
        ...
        b.prototype.drawDataLabels = function() {
            ...
            var c = this, e = c.chart, l = c.options, n = l.dataLabels, r = c.points, m, q, t = c.hasRendered || 0, x, u, d = y(n.defer, !!l.animation), H = e.renderer;
            if (n.enabled || c._hasPointLabels)
                c.dlProcessOptions && c.dlProcessOptions(n),
                u = c.plotGroup("dataLabelsGroup", "data-labels", d && !t ? "hidden" : "visible", n.zIndex || 6),
                d && (u.attr({
                    opacity: +t
                }),
                ...
                p(r, function(d) {
                    ...
                    (f = y(m && m.enabled, q.enabled) && !d.isNull) && (f = !0 === b(d, m || n));
                    f && (n = z(q, m),
                    r = d.getLabelConfig(),
                    E = n[d.formatPrefix + "Format"] || n.format,
                    x = G(E) ? g(E, r, e.time) : (n[d.formatPrefix + "Formatter"] || n.formatter).call(r, n),
                    E = n.style,
                    r = n.rotation,
                    E.color = y(n.color, E.color, c.color, "#000000"),
                    "contrast" === E.color && (d.contrastColor = H.getContrast(d.color || c.color),
                    E.color = n.inside || 0 > y(d.labelDistance, n.distance) || l.stacking ? d.contrastColor : "#000000"),
                    l.cursor && (E.cursor = l.cursor),
                    w = {
                    ...
                    !h || f && G(x) ? f && G(x) && (h ? w.text = x : (h = d.dataLabel = r ? H.text(x, 0, -9999).addClass("highcharts-data-label") : H.label(x, 0, -9999, n.shape, null, null, n.useHTML, null, "data-label"),
                    h.addClass(" highcharts-data-label-color-" + d.colorIndex + " " + (n.className || "") + (n.useHTML ? "highcharts-tracker" : ""))),
                    h.attr(w),
                    h.css(E).shadow(n.shadow),
                    h.added || h.add(u),
                    c.alignDataLabel(d, h, n, null, F)) : (d.dataLabel = h = h.destroy(),
        ...
        b.prototype.alignDataLabel = function(a, b, e, g, l) {
            var c = this.chart, f = c.inverted, h = y(a.dlBox && a.dlBox.centerX, a.plotX, -9999), n = y(a.plotY, -9999), x = b.getBBox(), w, d = e.rotation, t = e.align, E = this.visible && (a.series.forceDL || c.isInsidePlot(h, Math.round(n), f) || g && c.isInsidePlot(h, f ? g.x + 1 : g.y + g.height - 1, f)), k = "justify" === y(e.overflow, "justify");
            if (E && (w = e.style.fontSize,
            w = c.renderer.fontMetrics(w, b).b,
            g = m({
                x: f ? this.yAxis.len - n : h,
                y: Math.round(f ? this.xAxis.len - h : n),
                width: 0,
                height: 0
            }, g),
            m(e, {
            ...
            n = (d + 720) % 360,
            n = 180 < n && 360 > n,
            "left" === t ? h.y -= n ? x.height : 0 : "center" === t ? (h.x -= x.width / 2,
            h.y -= x.height / 2) : "right" === t && (h.x -= x.width,
            h.y -= n ? 0 : x.height),
            b.placed = !0,
            b.alignAttr = h) : (b.align(e, null, g),
            h = b.alignAttr),
            k ? a.isLabelJustified = this.justifyDataLabel(b, e, h, x, g, l) : y(e.crop, !0) && (E = c.isInsidePlot(h.x, h.y) && c.isInsidePlot(h.x + x.width, h.y + x.height)),
            e.shape && !d))
                b[l ? "attr" : "animate"]({
        ...
        b.prototype.justifyDataLabel = function(a, b, e, g, l, r) {
            ...
            n = e.x + d;
            0 > n && ("right" === f ? b.align = "left" : b.x = -n,
            m = !0);
            n = e.x + g.width - d;
            n > c.plotWidth && ("left" === f ? b.align = "right" : b.x = c.plotWidth - n,
            m = !0);
            n = e.y + d;
            0 > n && ("bottom" === h ? b.verticalAlign = "top" : b.y = -n,
            m = !0);
            n = e.y + g.height - d;
            n > c.plotHeight && ("top" === h ? b.verticalAlign = "bottom" : b.y = c.plotHeight - n,
            m = !0);
            m && (a.placed = !r,
            a.align(b, null, l));
            return m
        ...
        e.pie && (e.pie.prototype.drawDataLabels = function() {
            var f = this, c = f.data, e, g = f.chart, l = f.options.dataLabels, r = y(l.connectorPadding, 10), n = y(l.connectorWidth, 1), q = g.plotWidth, m = g.plotHeight, x = Math.round(g.chartWidth / 3), t, d = f.center, H = d[2] / 2, E = d[1], k, A, u, v, z = [[], []], B, N, M, S, O = [0, 0, 0, 0];
            f.visible && (l.enabled || f._hasPointLabels) && (p(c, function(a) {
            ...
            b.prototype.drawDataLabels.apply(f),
            p(c, function(a) {
                a.dataLabel && a.visible && (z[a.half].push(a),
                a.dataLabel._pos = null,
                !G(l.style.width) && !G(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > x && (a.dataLabel.css({
                    width: .7 * x
                }),
            ...
            p(z, function(b, c) {
                ...
                if (x)
                    for (f.sortByAngle(b, c - .5),
                    0 < f.maxLabelDistance && (h = Math.max(0, E - H - f.maxLabelDistance),
                    n = Math.min(E + H + f.maxLabelDistance, g.plotHeight),
                    p(b, function(a) {
                        0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, E - H - a.labelDistance),
                        a.bottom = Math.min(E + H + a.labelDistance, g.plotHeight),
                    ...
                    S = 0; S < x; S++)
                        ...
                        N = h = u[1],
                        t && G(t[n]) && (void 0 === t[n].pos ? M = "hidden" : (v = t[n].size,
                        N = e.top + t[n].pos)),
                        ...
                        u.x = B,
                        u.y = N,
                        y(l.crop, !0) && (A = k.getBBox().width,
                        h = null,
                        B - A < r && 1 === c ? (h = Math.round(A - B + r),
                        O[3] = Math.max(h, O[3])) : B + A > q - r && 0 === c && (h = Math.round(B + A - q + r),
                        O[1] = Math.max(h, O[1])),
                        0 > N - v / 2 ? O[0] = Math.max(Math.round(-N + v / 2), O[0]) : N + v / 2 > m && (O[2] = Math.max(Math.round(N + v / 2 - m), O[2])),
                        k.sideOverflow = h)
            }),
            0 === C(O) || this.verifyDataLabelOverflow(O)) && (this.placeDataLabels(),
            n && p(this.points, function(a) {
                ...
                if ((k = a.dataLabel) && k._pos && a.visible && 0 < a.labelDistance) {
                    ...
                    if (b = !t)
                        a.connector = t = g.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex + (a.className ? " " + a.className : "")).add(f.dataLabelsGroup),
                        t.attr({
                            "stroke-width": n,
        ...
        ,
        e.pie.prototype.alignDataLabel = u,
        e.pie.prototype.verifyDataLabelOverflow = function(a) {
            ...
            n || (null !== f[0] ? r = Math.max(b[2] - Math.max(a[1], a[3]), g) : (r = Math.max(b[2] - a[1] - a[3], g),
            b[0] += (a[3] - a[1]) / 2),
            null !== f[1] ? r = Math.max(Math.min(r, b[2] - Math.max(a[0], a[2])), g) : (r = Math.max(Math.min(r, b[2] - a[0] - a[2]), g),
            b[1] += (a[0] - a[2]) / 2),
            r < b[2] ? (b[2] = r,
            b[3] = Math.min(l(e.innerSize || 0, r), r),
            this.translate(b),
    ...
    (function(a) {
            ...
            C(this.series || [], function(g) {
                ...
                (m.enabled || g._hasPointLabels) && !m.allowOverlap && g.visible && C(z, function(m) {
                    C(g.points, function(g) {
                        g[m] && (g[m].labelrank = p(g.labelrank, g.shapeArgs && g.shapeArgs.height),
                        a.push(g[m]))
                    })
                })
            });
        ...
        B.prototype.hideOverlappingLabels = function(a) {
            ...
            for (p = 0; p < g; p++)
                ...
                m = p + 1; m < g; ++m)
                    if (y = a[m],
                    u && y && u !== y && u.placed && y.placed && 0 !== u.newOpacity && 0 !== y.newOpacity && (l = u.alignAttr,
                    b = y.alignAttr,
                    e = u.parentGroup,
                    t = y.parentGroup,
                    n = 2 * (u.box ? 0 : u.padding || 0),
                    l = f(l.x + e.translateX, l.y + e.translateY, u.width - n, u.height - n, b.x + t.translateX, b.y + t.translateY, y.width - n, y.height - n)))
                        (u.labelrank < y.labelrank ? u : y).newOpacity = 0;
            C(a, function(a) {
                var b, c;
                a && (c = a.newOpacity,
    ...
    (function(a) {
        var B = a.addEvent, C = a.Chart, G = a.createElement, p = a.css, m = a.defaultOptions, g = a.defaultPlotOptions, v = a.each, z = a.extend, u = a.fireEvent, y = a.hasTouch, l = a.inArray, b = a.isObject, e = a.Legend, t = a.merge, n = a.pick, f = a.Point, c = a.Series, h = a.seriesTypes, w = a.svg, D;
        D = a.TrackerMixin = {
            ...
            drawTrackerGraph: function() {
                var a = this, b = a.options, c = b.trackByArea, e = [].concat(c ? a.areaPath : a.graphPath), f = e.length, h = a.chart, d = h.pointer, g = h.renderer, l = h.options.tooltip.snap, k = a.tracker, n, m = function() {
                    if (h.hoverSeries !== a)
                        a.onMouseOver()
                }, t = "rgba(192,192,192," + (w ? .0001 : .002) + ")";
                if (f && !c)
                    for (n = f + 1; n--; )
                        "M" === e[n] && e.splice(n + 1, 0, e[n + 1] - l, e[n + 2], "L"),
                        (n && "M" === e[n] || n === f) && e.splice(n, 0, "L", e[n - 2] + l, e[n - 1]);
                k ? k.attr({
                    d: e
        ...
        z(f.prototype, {
            select: function(a, b) {
                ...
                c.firePointEvent(a ? "select" : "unselect", {
                    ...
                    b || v(f.getSelectedPoints(), function(a) {
                        ...
                        e.options.data[l(a, e.data)] = a.options,
                        a.setState(""),
            ...
            setState: function(a, b) {
                var c = Math.floor(this.plotX), e = this.plotY, f = this.series, h = f.options.states[a || "normal"] || {}, d = g[f.type].marker && f.options.marker, l = d && !1 === d.enabled, r = d && d.states && d.states[a || "normal"] || {}, k = !1 === r.enabled, m = f.stateMarkerGraphic, t = this.marker || {}, w = f.chart, p = f.halo, D, v = d && f.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === h.enabled || a && (k || l && !1 === r.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                    ...
                    if (this.graphic)
                        ...
                        this.graphic.animate(f.pointAttribs(this, a), n(w.options.chart.animation, h.animation)),
                        D && this.graphic.animate(D, n(w.options.chart.animation, r.animation, d.animation)),
                        m && m.hide();
                    else {
                        if (a && r) {
                            d = t.symbol || f.symbol;
                            ...
                            if (m)
                                ...
                                d && (f.stateMarkerGraphic = m = w.renderer.symbol(d, D.x, D.y, D.width, D.height).add(f.markerGroup),
                                m.currentSymbol = d);
                            m && m.attr(f.pointAttribs(this, a))
                        }
                        m && (m[a && w.isInsidePlot(c, e, w.inverted) ? "show" : "hide"](),
                        m.element.point = this)
                    }
                    (c = h.halo) && c.size ? (p || (f.halo = p = w.renderer.path().add((this.graphic || m).parentGroup)),
                    p.show()[b ? "animate" : "attr"]({
        ...
        z(c.prototype, {
            ...
            setState: function(a) {
                ...
                e && !e.dashstyle))
                    ...
                    e.animate(h, n(f[a || "normal"] && f[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c]; )
                        b["zone-graph-" + c].attr(h),
                        c += 1
            },
            setVisible: function(a, b) {
    ...
    (function(a) {
        ...
        B.prototype.setResponsive = function(g) {
            ...
            var b = a.merge.apply(0, a.map(p, function(b) {
              ...
              , p = p.toString() || void 0;
            p !== (l && l.ruleIds) && (l && this.update(l.undoOptions, g),
            ...
            function u(g, b, e, t) {
                ...
                a.objectEach(g, function(a, c) {
                    if (!t && -1 < G(c, ["series", "xAxis", "yAxis"]))
                        ...
                        l = 0; l < a.length; l++)
                            b[c][l] && (e[c][l] = {},
                            u(a[l], b[c][l], e[c][l], t + 1));
                    else
                        m(a) ? (e[c] = p(a) ? [] : {},
                        u(a, b[c] || {}, e[c], t + 1)) : e[c] = b[c] || null
                })
            }
            var y = {};
    ...
    (function(a) {
        ...
        l(C.prototype, "getTimeTicks", function(a, e, g, l, f, c, h, w) {
            var b = 0, n, t, q = {}, p, x, u, d = [], H = -Number.MAX_VALUE, E = this.options.tickPixelInterval, k = this.chart.time;
            if (!this.options.ordinal && !this.options.breaks || !c || 3 > c.length || void 0 === g)
                return a.call(this, e, g, l, f);
            x = c.length;
            for (n = 0; n < x; n++) {
                u = n && c[n - 1] > l;
                c[n] < g && (b = n);
                if (n === x - 1 || c[n + 1] - c[n] > 5 * h || u) {
                    if (c[n] > H) {
                        for (t = a.call(this, e, c[b], c[n], f); t.length && t[0] <= H; )
                            t.shift();
            ...
            if (w && a.unitRange <= y.hour) {
                n = d.length - 1;
                for (b = 1; b < n; b++)
                    k.dateFormat("%d", d[b]) !== k.dateFormat("%d", d[b - 1]) && (q[d[b]] = "day",
                    p = !0);
                p && (q[d[0]] = "day");
                a.higherRanks = q
            }
            ...
            if (w && m(E)) {
                ...
                for (A = void 0; w--; )
                    b = n[w],
                    l = Math.abs(A - b),
                    A && l < .8 * E && (null === p || l < .8 * p) ? (q[d[w]] && !q[d[w + 1]] ? (l = w + 1,
                    A = b) : l = w,
                    d.splice(l, 1)) : A = b
            }
            return d
        ...
        v(C.prototype, {
            beforeSetTickPositions: function() {
                var a, e = [], l = !1, n, f = this.getExtremes(), c = f.min, h = f.max, w, p = this.isXAxis && !!this.options.breaks, f = this.options.ordinal, r = Number.MAX_VALUE, v = this.chart.options.chart.ignoreHiddenSeries;
                n = "highcharts-navigator-xaxis" === this.options.className;
                !this.options.overscroll || this.max !== this.dataMax || this.chart.mouseIsDown && !n || this.eventArgs && (!this.eventArgs || "navigator" === this.eventArgs.trigger) || (this.max += this.options.overscroll,
                !n && m(this.userMin) && (this.min += this.options.overscroll));
                if (f || p) {
                    g(this.series, function(b, c) {
                        if (!(v && !1 === b.visible || !1 === b.takeOrdinalPosition && !p) && (e = e.concat(b.processedXData),
                        a = e.length,
                        e.sort(function(a, b) {
                            return a - b
                        }),
                        r = Math.min(r, u(b.closestPointRange, r)),
                        a))
                            for (c = a - 1; c--; )
                    ...
                    if (2 < a) {
                        ...
                        this.options.overscroll && (2 === a ? r = e[1] - e[0] : 1 === a ? (r = this.options.overscroll,
                        e = [e[0], e[0] + r]) : r = this.overscrollPointsRange);
                    l ? (this.options.overscroll && (this.overscrollPointsRange = r,
                    e = e.concat(this.getOverscrollPositions())),
                    this.ordinalPositions = e,
                    n = this.ordinal2lin(Math.max(c, e[0]), !0),
                    w = Math.max(this.ordinal2lin(Math.min(h, e[e.length - 1]), !0), 1),
                    this.ordinalSlope = h = (h - c) / (w - n),
                    this.ordinalOffset = c - n * h) : (this.overscrollPointsRange = u(this.closestPointRange, this.overscrollPointsRange),
            ...
            lin2val: function(a, e) {
                ...
                if (b) {
                    ...
                    if (e)
                        0 > a ? a = b[0] : a > c ? a = b[c] : (c = Math.floor(a),
                        h = a - c);
                    else
                        for (; c--; )
                            if (e = g * c + f,
            ...
            getExtendedPositions: function() {
                var a = this, e = a.chart, l = a.series[0].currentDataGrouping, n = a.ordinalIndex, f = l ? l.count + l.unitName : "raw", c = a.options.overscroll, h = a.getExtremes(), m, p;
                n || (n = a.ordinalIndex = {});
                n[f] || (m = {
                    series: [],
                    chart: e,
        ...
        l(G.prototype, "pan", function(a, e) {
            ...
            if (b.options.ordinal && b.series.length) {
                var h = this.mouseDownX, m = b.getExtremes(), u = m.dataMax, r = m.min, v = m.max, q = this.hoverPoints, F = b.closestPointRange || b.overscrollPointsRange, h = (h - f) / (b.translationSlope * (b.ordinalSlope || F)), x = {
                ...
                0 > h ? (q = x,
                d = b.ordinalPositions ? b : x) : (q = b.ordinalPositions ? b : x,
                d = x),
                x = d.ordinalPositions,
                u > x[x.length - 1] && x.push(u),
                this.fixedRange = v - r,
                h = b.toFixedRange(null, null, F.apply(q, [y.apply(q, [r, !0]) + h, !0]), F.apply(d, [y.apply(d, [v, !0]) + h, !0])),
                h.min >= Math.min(m.dataMin, r) && h.max <= Math.max(u, v) + l && b.setExtremes(h.min, h.max, !0, !1, {
                    trigger: "pan"
                }),
                this.mouseDownX = f,
                p(this.container, {
    ...
    (function(a) {
        ...
        v(y.prototype, {
            ...
            isInAnyBreak: function(a, e) {
                ...
                if (g) {
                    for (; g--; )
                        this.isInBreak(b[g], a) && (f = !0,
                        c || (c = p(b[g].showPoints, this.isXAxis ? !1 : !0)));
                    h = f && e ? f && !c : f
                }
                return h
            }
        ...
        G(y, "afterSetTickPositions", function() {
            if (this.options.breaks) {
                ...
                for (l = 0; l < a.length; l++)
                    this.isInAnyBreak(a[l]) || g.push(a[l]);
        ...
        G(y, "afterInit", function() {
            ...
            a.lin2val = function(b) {
                var e, f;
                for (f = 0; f < a.breakArray.length && !(e = a.breakArray[f],
                e.from >= b); f++)
                    e.to < b ? b += e.len : a.isInBreak(e, b) && (b += e.len);
                return b
            }
            ,
            ...
            a.setAxisTranslation = function(b) {
                ...
                b = a.options.breaks;
                var e = [], f = [], c = 0, h, l, m = a.userMin || a.min, r = a.userMax || a.max, t = p(a.pointRangePadding, 0), q, v;
                g(b, function(b) {
                    l = b.repeat || Infinity;
        ...
        m(l.prototype, "generatePoints", function(a) {
            ...
            if (b && g && (b.options.breaks || g.options.breaks))
                for (; c--; )
                    f = l[c],
                    m = null === f.y && !1 === h,
                    m || !b.isInAnyBreak(f.x, !0) && !g.isInAnyBreak(f.y, !0) || (l.splice(c, 1),
                    this.data[c] && this.data[c].destroyElements())
        });
        a.Series.prototype.drawBreaks = function(a, e) {
            ...
            a && g(e, function(e) {
                ...
                g(l, function(b) {
                    ...
                    g(f, function(e) {
                        h = !1;
                        if (c < e.from && m > e.to || c > e.from && m < e.from)
                            h = "pointBreak";
                        else if (c < e.from && m > e.from && m < e.to || c > e.from && m > e.to && m < e.from)
                            h = "pointInBreak";
                        h && u(a, h, {
                            point: b,
                            brk: e
        ...
        a.Series.prototype.gappedPath = function() {
            var b = this.currentDataGrouping
              ...
              , f = this.yAxis;
            if (b && 0 < l)
                for ("value" !== this.options.gapUnit && (b *= this.closestPointRange),
                e && e > b && (b = e); l--; )
                    g[l + 1].x - g[l].x > b && (e = (g[l].x + g[l + 1].x) / 2,
                    g.splice(l + 1, 0, {
                        isNull: !0,
                        x: e
                    }),
                    this.options.stacking && (e = f.stacks[this.stackKey][e] = new a.StackItem(f,f.options.stackLabels,!1,e,this.stack),
                    e.total = 0));
            return this.getGraphPath(g)
        }
        ;
        m(a.seriesTypes.column.prototype, "drawPoints", C);
        m(a.Series.prototype, "drawPoints", C)
    }
    )(L);
    (function(a) {
        var B = a.addEvent
        ...
        c.groupData = function(a, b, c, d) {
            ...
            for (z; z <= l; z++) {
                ...
                if (x) {
                    ...
                    for (m = 0; m < t; m++)
                        B = J[x[m]],
                        y(B) ? w[m].push(B) : null === B && (w[m].hasNulls = !0)
                } else
                    m = p ? b[z] : null,
                    y(m) ? w[0].push(m) : null === m && (w[0].hasNulls = !0)
            }
            return [k, h, g]
        }
        ;
        c.processData = function() {
            var a = this.chart, e = this.options.dataGrouping, f = !1 !== this.allowDG && e && b(e.enabled, a.options.isStock), d = this.visible || !a.options.chart.ignoreHiddenSeries, l, m = this.currentDataGrouping, k;
            this.forceCrop = f;
            this.groupPixelWidth = null;
            this.hasProcessed = !0;
            if (!1 !== h.apply(this, arguments) && f) {
                this.destroyGroupedData();
                var n, q = e.groupAll ? this.xData : this.processedXData, r = e.groupAll ? this.yData : this.processedYData, p = a.plotSizeX, a = this.xAxis, w = a.options.ordinal, t = this.groupPixelWidth = a.getGroupPixelWidth && a.getGroupPixelWidth();
                if (t) {
                    this.isDirty = l = !0;
                    this.points = null;
                    f = a.getExtremes();
                    ...
                    this.groupMap = r[2];
                    g(q[0]) && q[0] < a.dataMin && d && (a.min <= a.dataMin && (a.min = q[0]),
                    a.dataMin = q[0]);
                    e.groupAll && (e = this.cropData(q, w, a.min, a.max, 1),
                    q = e.xData,
                    w = e.yData);
        ...
        f(n.prototype, "tooltipFooterHeaderFormatter", function(a, b, c) {
            var d = this.chart.time, e = b.series, f = e.tooltipOptions, k = e.options.dataGrouping, h = f.xDateFormat, g, l = e.xAxis;
            return l && "datetime" === l.options.type && k && y(b.key) ? (a = e.currentDataGrouping,
            k = k.dateTimeLabelFormats,
            a ? (l = k[a.unitName],
            1 === a.count ? h = l[0] : (h = l[1],
            g = l[2])) : !h && k && (h = this.getXDateFormat(b, f, l)),
            h = d.dateFormat(h, b.key),
            g && (h += d.dateFormat(g, b.key + a.totalRange - 1)),
            u(f[(c ? "footer" : "header") + "Format"], {
                point: z(b.point, {
                    key: h
                }),
                series: e
        ...
        B(t, "afterSetOptions", function(a) {
            ...
            if (r[b] || e)
                d || (d = l(D, r[b])),
                a.dataGrouping = l(e, d, c.series && c.series.dataGrouping, c[b].dataGrouping, this.userOptions.dataGrouping);
        ...
        p.prototype.setDataGrouping = function(a, c) {
            ...
            if (this instanceof p)
                ...
                v(this.chart.options.series, function(b) {
                    b.dataGrouping = a
                }, !1);
        ...
        G("ohlc", "column", {
            ...
            translate: function() {
                ...
                B(a.points, function(m) {
                    B([m.open, m.high, m.low, m.close, m.low], function(p, l) {
                        null !== p && (v && (p = a.modifyValue(p)),
                        m[z[l]] = g.toPixels(p, !0))
                    });
            ...
            drawPoints: function() {
                ...
                B(a.points, function(m) {
                    ...
                    void 0 !== m.plotY && (b || (m.graphic = b = g.renderer.path().add(a.group)),
                    b.attr(a.pointAttribs(m, m.selected && "select")),
                    u = b.strokeWidth() % 2 / 2,
                    e = Math.round(m.plotX) - u,
                    v = Math.round(m.shapeArgs.width / 2),
                    l = ["M", e, Math.round(m.yBottom), "L", e, Math.round(m.plotHigh)],
                    null !== m.open && (p = Math.round(m.plotOpen) + u,
                    l.push("M", e, p, "L", e - v, p)),
                    null !== m.close && (p = Math.round(m.plotClose) + u,
                    l.push("M", e, p, "L", e + v, p)),
                    b[t ? "attr" : "animate"]({
                        d: l
    ...
    (function(a) {
        ...
        p("candlestick", "ohlc", G(B.column, {
            ...
            pointAttribs: function(a, p) {
                ...
                g.stroke = a.lineColor || (v ? u.upLineColor || l : l);
                p && (a = u.states[p],
            ...
            drawPoints: function() {
                ...
                C(a.points, function(g) {
                    ...
                    void 0 !== g.plotY && (p || (g.graphic = p = m.renderer.path().add(a.group)),
                    p.attr(a.pointAttribs(g, g.selected && "select")).shadow(a.options.shadow),
                    t = p.strokeWidth() % 2 / 2,
                    n = Math.round(g.plotX) - t,
                    v = g.plotOpen,
                    l = g.plotClose,
                    b = Math.min(v, l),
                    v = Math.max(v, l),
                    f = Math.round(g.shapeArgs.width / 2),
                    l = Math.round(b) !== Math.round(g.plotHigh),
                    e = v !== g.yBottom,
                    b = Math.round(b) + t,
                    v = Math.round(v) + t,
                    t = [],
                    t.push("M", n - f, v, "L", n - f, b, "L", n + f, b, "L", n + f, v, "Z", "M", n, b, "L", n, l ? Math.round(g.plotHigh) : b, "M", n, v, "L", n, e ? Math.round(g.yBottom) : v),
                    p[c ? "attr" : "animate"]({
                        d: t
    ...
    da = function(a) {
        ...
        return {
            ...
            translate: function() {
                ...
                var a = this.options, g = this.chart, v = this.points, z = v.length - 1, u, y, l = a.onSeries, l = l && g.get(l), a = a.onKey || "y", b = l && l.options.step, e = l && l.points, t = e && e.length, n = g.inverted, f = this.xAxis, c = this.yAxis, h = 0, w, D, r, J;
                if (l && l.visible && t)
                    for (h = (l.pointXOffset || 0) + (l.barW || 0) / 2,
                    u = l.currentDataGrouping,
                    D = e[t - 1].x + (u ? u.totalRange : 0),
                    p(v, function(a, b) {
                        return a.x - b.x
                    }),
                    a = "plot" + a[0].toUpperCase() + a.substr(1); t-- && v[z] && !(w = e[t],
                    u = v[z],
                    u.y = w.y,
                    w.x <= u.x && void 0 !== w[a] && (u.x <= D && (u.plotY = w[a],
                    w.x < u.x && !b && (r = e[t + 1]) && void 0 !== r[a] && (J = (u.x - w.x) / (r.x - w.x),
                    u.plotY += J * (r[a] - w[a]),
                    u.y += J * (r.y - w.y))),
                    z--,
                    t++,
                ...
                B(v, function(a, b) {
                    ...
                    a.plotX += h;
                    if (void 0 === a.plotY || n)
                        0 <= a.plotX && a.plotX <= f.len ? n ? (a.plotY = f.translate(a.x, 0, 1, 0, 1),
                        a.plotX = C(a.y) ? c.translate(a.y, 0, 0, 0, 1) : 0) : a.plotY = g.chartHeight - f.bottom - (f.opposite ? f.height : 0) + f.offset - c.top : a.shapeArgs = {};
                    (y = v[b - 1]) && y.plotX === a.plotX && (void 0 === y.stackIndex && (y.stackIndex = 0),
                    e = y.stackIndex + 1);
                    a.stackIndex = e
                });
                this.onSeries = l
    ...
    (function(a, B) {
        function C(a) {
            l[a + "pin"] = function(b, g, m, f, c) {
                var e = c && c.anchorX;
                c = c && c.anchorY;
                "circle" === a && f > m && (b -= Math.round((f - m) / 2),
                m = f);
                b = l[a](b, g, m, f);
                e && c && (b.push("M", "circle" === a ? b[1] - b[4] : b[1] + b[4] / 2, g > c ? g : g + f, "L", e, c),
                b = b.concat(l.circle(e - 1, c - 1, 2, 2)));
                return b
            }
        }
        var G = a.addEvent
        ...
        z("flags", "column", {
            ...
            pointAttribs: function(a, e) {
                ...
                e && (a = b.states[e].fillColor,
                f = b.states[e].lineColor,
                c = b.states[e].lineWidth);
                return {
                    fill: a || g,
                    stroke: f || g,
            ...
            drawPoints: function() {
                var b = this.points, e = this.chart, g = e.renderer, l, f, c = e.inverted, h = this.options, w = h.y, u, r, v, q, y, x, z = this.yAxis, d = {}, H = [];
                for (r = b.length; r--; )
                    v = b[r],
                    x = (c ? v.plotY : v.plotX) > this.xAxis.len,
                    l = v.plotX,
                    q = v.stackIndex,
                    u = v.options.shape || h.shape,
                    f = v.plotY,
                    void 0 !== f && (f = v.plotY + w - (void 0 !== q && q * h.stackDistance)),
                    v.anchorX = q ? void 0 : v.plotX,
                    y = q ? void 0 : v.plotY,
                    q = v.graphic,
                    void 0 !== f && 0 <= l && !x ? (q || (q = v.graphic = g.label("", null, null, u, null, null, h.useHTML).attr(this.pointAttribs(v)).css(m(h.style, v.style)).attr({
                        align: "flag" === u ? "left" : "center",
                        width: h.width,
                        height: h.height,
                        "text-align": h.textAlign
                    }).addClass("highcharts-point").add(this.markerGroup),
                    v.graphic.div && (v.graphic.div.point = v),
                    q.shadow(h.shadow),
                    q.isNew = !0),
                    0 < l && (l -= q.strokeWidth() % 2),
                    u = {
                        y: f,
                        anchorY: y
                    },
                    h.allowOverlapX && (u.x = l,
                    u.anchorX = v.anchorX),
                    q.attr({
                        text: v.options.title || h.title || "A"
                    })[q.isNew ? "attr" : "animate"](u),
                    h.allowOverlapX || (d[v.plotX] ? d[v.plotX].size = Math.max(d[v.plotX].size, q.width) : d[v.plotX] = {
                        align: 0,
                        size: q.width,
                        target: l,
                        anchorX: l
                ...
                a.distribute(H, c ? z.len : this.xAxis.len, 100),
                p(b, function(a) {
    ...
    (function(a) {
        ...
        var C = a.addEvent, G = a.Axis, p = a.correctFloat, m = a.defaultOptions, g = a.defined, v = a.destroyObjectProperties, z = a.each, u = a.fireEvent, y = a.hasTouch, l = a.isTouchDevice, b = a.merge, e = a.pick, t = a.removeEvent, n = a.wrap, f, c = {
            height: l ? 20 : 14,
            barBorderRadius: 0,
        ...
        B.prototype = {
            ...
            render: function() {
                ...
                this.scrollbarRifles = a.path(f(["M", -3, c / 4, "L", -3, 2 * c / 3, "M", 0, c / 4, "L", 0, 2 * c / 3, "M", 3, c / 4, "L", 3, 2 * c / 3], b.vertical)).addClass("highcharts-scrollbar-rifles").add(this.scrollbarGroup);
                this.scrollbar.attr({
            ...
            position: function(a, b, c, e) {
                ...
                this.yOffset = h;
                f ? (this.width = this.yOffset = c = h = this.size,
                this.xOffset = b = 0,
                this.barWidth = e - 2 * c,
                this.x = a += this.options.margin) : (this.height = this.xOffset = e = b = this.size,
                this.barWidth = c - 2 * e,
            ...
            setRange: function(a, b) {
                var c = this.options, e = c.vertical, f = c.minWidth, h = this.barWidth, l, m, n = this.rendered && !this.hasDragged ? "animate" : "attr";
                g(h) && (a = Math.max(a, 0),
                l = Math.ceil(h * a),
                this.calculatedWidth = m = p(h * Math.min(b, 1) - l),
                m < f && (l = (h - f + m) * a,
                m = f),
                ...
                this.scrollbarTop = f,
                this.scrollbarLeft = 0) : (this.scrollbarGroup[n]({
                    translateX: f
                }),
                this.scrollbar[n]({
                    width: m
            ...
            initEvents: function() {
                ...
                a.mouseMoveHandler = function(b) {
                    var c = a.chart.pointer.normalize(b)
                      ...
                      , f = a.initPositions;
                    !a.grabbedCenter || b.touches && 0 === b.touches[0][e] || (c = a.cursorToScrollbarPosition(c)[e],
                    e = a[e],
                    e = c - e,
                    a.hasDragged = !0,
        ...
        n(G.prototype, "init", function(a) {
            ...
            C(b.scrollbar, "changed", function(a) {
                var c = Math.min(e(b.options.min, b.min), b.min, b.dataMin), f = Math.max(e(b.options.max, b.max), b.max, b.dataMax) - c, g;
                b.horiz && !b.reversed || !b.horiz && b.reversed ? (g = c + f * this.to,
                c += f * this.from) : (g = c + f * (1 - this.from),
                c += f * (1 - this.to));
        ...
        n(G.prototype, "render", function(a) {
            ...
            a.apply(this, Array.prototype.slice.call(arguments, 1));
            if (f) {
                this.horiz ? (f.position(this.left, this.top + this.height + 2 + this.chart.scrollbarsOffsets[1] + (this.opposite ? 0 : h + this.axisTitleMargin + this.offset), this.width, this.height),
                h = 1) : (f.position(this.left + this.width + 2 + this.chart.scrollbarsOffsets[0] + (this.opposite ? h + this.axisTitleMargin + this.offset : 0), this.top, this.width, this.height),
                h = 0);
                if (!this.opposite && !this.horiz || this.opposite && this.horiz)
                    this.chart.scrollbarsOffsets[h] += this.scrollbar.size + this.scrollbar.options.margin;
                isNaN(b) || isNaN(c) || !g(this.min) || !g(this.max) ? f.setRange(0, 0) : (h = (this.min - b) / (c - b),
                b = (this.max - b) / (c - b),
                this.horiz && !this.reversed || !this.horiz && this.reversed ? f.setRange(h, b) : f.setRange(1 - b, 1 - h))
            }
        });
    ...
    (function(a) {
        ...
        B.prototype = {
            ...
            drawOutline: function(a, b, c, e) {
                ...
                c = n + b + f,
                b = n + a + f,
                a = ["M", m + g, n - h - f, "L", m + g, c, "L", m, c, "L", m, b, "L", m + g, b, "L", m + g, n + l + h].concat(d ? ["M", m + g, c - k, "L", m + g, b + k] : [])) : (a += m + h - f,
                b += m + h - f,
                n += k,
                a = ["M", m, n, "L", a, n, "L", a, n + g, "L", b, n + g, "L", b, n, "L", m + l + 2 * h, n].concat(d ? ["M", a - k, n, "L", b + k, n] : []));
                this.outline[e]({
                    d: a
                })
            },
            drawMasks: function(a, b, c, e) {
                ...
                m = [f, f + a, f + b],
                h = [k, k, k],
                g = [a, b - a, this.size - b]) : (l = [d, d + a, d + b],
                m = [f, f, f],
                h = [a, b - a, this.size - b],
                g = [k, k, k]);
            ...
            render: function(b, c, e, k) {
                ...
                h = d.inverted;
                var t, x = d.xAxis[0].minRange, u = d.xAxis[0].options.maxRange;
                if (!this.hasDragged || v(e)) {
                    ...
                    f(e) && Infinity !== Math.abs(e) || (e = 0,
                    k = d);
                    b = n.toValue(e, !0);
                    c = n.toValue(k, !0);
                    t = Math.abs(a.correctFloat(c - b));
                    t < x ? this.grabbedLeft ? e = n.toPixels(c - x, !0) : this.grabbedRight && (k = n.toPixels(b + x, !0)) : v(u) && t > u && (this.grabbedLeft ? e = n.toPixels(c - u, !0) : this.grabbedRight && (k = n.toPixels(b + u, !0)));
                    ...
                    this.drawMasks(e, p, h, r),
                    this.drawOutline(e, p, h, r),
                    this.navigatorOptions.handles.enabled && (this.drawHandle(e, 0, h, r),
                    this.drawHandle(p, 1, h, r)));
                    this.scrollbar && (h ? (h = this.top - l,
                    g = this.left - l + (q || !g.opposite ? 0 : (g.titleOffset || 0) + g.axisTitleMargin),
                    l = m + 2 * l) : (h = this.top + (q ? this.height : -l),
                    g = this.left - l),
                    this.scrollbar.position(g, h, d, l),
                    this.scrollbar.setRange(this.zoomedMin / m, this.zoomedMax / m));
                    this.rendered = !0
                }
            },
            addMouseEvents: function() {
                ...
                t && (e.push(C(c, "touchmove", f), C(c.ownerDocument, "touchend", g)),
            ...
            shadesMousedown: function(a, b) {
                ...
                var d = this.chart, c = this.xAxis, e = this.zoomedMin, f = this.left, g = this.size, h = this.range, l = a.chartX, m, n;
                d.inverted && (l = a.chartY,
                f = this.top);
                1 === b ? (this.grabbedCenter = l,
                this.fixedWidth = h,
                this.dragOffset = l - e) : (a = l - f - h / 2,
                0 === b ? a = Math.max(0, a) : 2 === b && a + h >= g && (a = g - h,
                c.reversed ? (a -= h,
                n = this.getUnionExtremes().dataMin) : m = this.getUnionExtremes().dataMax),
                a !== e && (this.fixedWidth = h,
                b = c.toFixedRange(a, a + h, n, m),
                v(b.min) && d.xAxis[0].setExtremes(Math.min(b.min, b.max), Math.max(b.min, b.max), !0, null, {
                    trigger: "navigator"
                })))
            },
            handlesMousedown: function(a, b) {
                ...
                this.fixedExtreme = c ? d.min : d.max) : (this.grabbedRight = !0,
                this.otherHandlePos = this.zoomedMin,
                this.fixedExtreme = c ? d.max : d.min);
                a.fixedRange = null
            },
            onMouseMove: function(a) {
                var b = this
                  ...
                  , g = b.dragOffset
                  , h = d.inverted;
                a.touches && 0 === a.touches[0].pageX || (a = d.pointer.normalize(a),
                d = a.chartX,
                h && (c = b.top,
                d = a.chartY),
                b.grabbedLeft ? (b.hasDragged = !0,
                b.render(0, 0, d - c, b.otherHandlePos)) : b.grabbedRight ? (b.hasDragged = !0,
                b.render(0, 0, b.otherHandlePos, d - c)) : b.grabbedCenter && (b.hasDragged = !0,
            ...
            onMouseUp: function(a) {
                var b = this.chart, d = this.xAxis, c = d && d.reversed, e = this.scrollbar, f, g, h = a.DOMEvent || a;
                (!this.hasDragged || e && e.hasDragged) && "scrollbar" !== a.trigger || (e = this.getUnionExtremes(),
                this.zoomedMin === this.otherHandlePos ? f = this.fixedExtreme : this.zoomedMax === this.otherHandlePos && (g = this.fixedExtreme),
                this.zoomedMax === this.size && (g = c ? e.dataMin : e.dataMax),
                0 === this.zoomedMin && (f = c ? e.dataMax : e.dataMin),
                d = d.toFixedRange(this.zoomedMin, this.zoomedMax, f, g),
                v(d.min) && b.xAxis[0].setExtremes(Math.min(d.min, d.max), Math.max(d.min, d.max), !0, this.hasDragged ? !1 : null, {
                    trigger: "navigator",
            ...
            removeBaseSeriesEvents: function() {
                ...
                a[0].xAxis && D(a[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes))
            },
            init: function(a) {
                var b = a.options
                  , d = b.navigator
                ...
                C(l.scrollbar, "changed", function(b) {
                    var d = l.size
                      , c = d * this.to
                      , d = d * this.from;
            ...
            updateNavigatorSeries: function(d, c) {
                var e = this, f = e.chart, l = e.baseSeries, m, q, p = e.navigatorOptions.series, r, t = {
                    ...
                    var d = b.baseSeries;
                    return 0 > a.inArray(d, l) ? (d && (D(d, "updatedData", e.updatedDataHandler),
                ...
                l && l.length && u(l, function(a) {
                    ...
                    d && !1 === e.navigatorOptions.adaptToUpdatedData || (t.name = "Navigator " + l.length,
                    m = a.options || {},
                    r = m.navigatorOptions || {},
                    q = h(m, t, k, r),
                    k = r.data || k.data,
                    e.hasNavigatorData = e.hasNavigatorData || !!k,
                    q.data = k || m.data && m.data.slice(0),
                    d && d.options ? d.update(q, c) : (a.navigatorSeries = f.initSeries(q),
                    a.navigatorSeries.baseSeries = a,
                    x.push(a.navigatorSeries)))
                });
                if (p.data && (!l || !l.length) || n(p))
                    ...
                    u(p, function(a, b) {
                        ...
                        q.data = a.data;
                        q.data && (e.hasNavigatorData = !0,
                        x.push(f.initSeries(q)))
                    });
            ...
            addBaseSeriesEvents: function() {
                ...
                u(b, function(b) {
                    ...
                    C(b, "remove", function() {
                        this.navigatorSeries && (y(a.series, this.navigatorSeries),
                        v(this.navigatorSeries.options) && this.navigatorSeries.remove(!1),
            ...
            modifyBaseAxisExtremes: function() {
                var a = this.chart.navigator, b = this.getExtremes(), c = b.dataMin, e = b.dataMax, b = b.max - b.min, g = a.stickToMin, h = a.stickToMax, l = w(this.options.overscroll, 0), m, n, q = a.series && a.series[0], p = !!this.setExtremes;
                this.eventArgs && "rangeSelectorButton" === this.eventArgs.trigger || (g && (n = c,
                m = n + b),
                h && (m = e + l,
                g || (n = Math.max(m - b, q && q.xData ? q.xData[0] : -Number.MAX_VALUE))),
                p && (g || h) && f(n) && (this.min = this.userMin = n,
                this.max = this.userMax = m));
        ...
        F(G.prototype, "zoom", function(a, b, c) {
            var d = this.chart, e = d.options, f = e.chart.zoomType, g = e.chart.pinchType, h = e.navigator, e = e.rangeSelector, l;
            this.isXAxis && (h && h.enabled || e && e.enabled) && ("x" === f || "x" === g ? d.resetZoomButton = "blocked" : "y" === f ? l = !1 : "xy" !== f && "xy" !== g || !this.options.range || (d = this.previousZoom,
            v(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0],
            c = d[1],
        ...
        C(p, "afterSetChartSize", function() {
            var a = this.legend, b = this.navigator, c, e, f, g;
            b && (e = a && a.options,
            f = b.xAxis,
            g = b.yAxis,
            c = b.scrollbarHeight,
            this.inverted ? (b.left = b.opposite ? this.chartWidth - c - b.height : this.spacing[3] + c,
            b.top = this.plotTop + c) : (b.left = this.plotLeft + c,
            b.top = b.navigatorOptions.top || this.chartHeight - b.height - c - this.spacing[2] - (this.rangeSelector && this.extraBottomMargin ? this.rangeSelector.getHeight() : 0) - (e && "bottom" === e.verticalAlign && e.enabled && !e.floating ? a.legendHeight + w(e.margin, 10) : 0)),
            f && g && (this.inverted ? f.options.left = g.options.left = b.left : f.options.top = g.options.top = b.top,
            f.setAxisSize(),
            g.setAxisSize()))
        });
    ...
    (function(a) {
        ...
        B.prototype = {
            clickButton: function(a, b) {
                var c = this, e = c.chart, g = c.buttonOptions[a], m = e.xAxis[0], n = e.scroller && e.scroller.getUnionExtremes() || m || {}, d = n.dataMin, p = n.dataMax, r, k = m && Math.round(Math.min(m.max, f(p, m.max))), u = g.type, v, n = g._range, w, D, y, z = g.dataGrouping;
                if (null !== d && null !== p) {
                    e.fixedRange = n;
                    z && (this.forcedDataGrouping = !0,
                    G.prototype.setDataGrouping.call(m || {
                        chart: this.chart
                    }, z, !1));
                    if ("month" === u || "year" === u)
                        m ? (u = {
                        ...
                        r = m.minFromRange.call(u),
                        t(u.newMax) && (k = u.newMax)) : n = g;
                    else if (n)
                        r = Math.max(k - n, d),
                        k = Math.min(r + n, p);
                    else if ("ytd" === u)
                        if (m)
                            void 0 === p && (d = Number.MAX_VALUE,
                            p = Number.MIN_VALUE,
                            l(e.series, function(a) {
                                a = a.xData;
                                d = Math.min(a[0], d);
                                p = Math.max(a[a.length - 1], p)
                            }),
                            b = !1),
                            k = c.getYTDExtremes(p, d, e.time.useUTC),
                            r = w = k.min,
                            k = k.max;
                        else {
            ...
            init: function(a) {
                ...
                C(a, "load", function() {
                    a.xAxis && a.xAxis[0] && C(a.xAxis[0], "setExtremes", function(c) {
            ...
            updateButtonStates: function() {
                var a = this.chart
                  ...
                  , u = this.buttons;
                l(this.buttonOptions, function(a, f) {
                    var l = a._range
                      , q = a.type
                      , r = a.count || 1
                      , t = u[f]
                    ...
                    ("month" === q || "year" === q) && c + 36E5 >= 864E5 * {
                        ...
                        month: 31,
                        year: 366
                    }[q] * r + a ? l = !0 : "ytd" === q ? (l = m - d + a === c,
                    A = !f) : "all" === q && (l = b.max - b.min >= h - g,
                    y = !f && k && l);
                    q = !p && (x || w || y || e);
                    r = f && l || l && !k && !A;
                    q ? v = 3 : r && (k = !0,
            ...
            drawInput: function(a) {
                function e() {
                    var a = y.value
                      ...
                      , g = e.dataMin
                      , e = e.dataMax;
                    b !== y.previousValue && (y.previousValue = b,
                    t(b) || (b = a.split("-"),
                    b = Date.UTC(c(b[0]), c(b[1]) - 1, c(b[2]))),
                    t(b) && (h.time.useUTC || (b += 6E4 * (new Date).getTimezoneOffset()),
                    w ? b > f.maxInput.HCTime ? b = void 0 : b < g && (b = g) : b < f.minInput.HCTime ? b = void 0 : b > e && (b = e),
                    void 0 !== b && d.setExtremes(w ? b : d.min, w ? d.max : b, void 0, void 0, {
                        trigger: "rangeSelectorInput"
                    })))
                }
                var f = this, h = f.chart, l = h.renderer.style || {}, p = h.renderer, u = h.options.rangeSelector, d = f.div, w = "min" === a, y, k, A = this.inputGroup;
                this[a + "Label"] = k = p.label(v.lang[w ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).addClass("highcharts-range-label").attr({
                    padding: 2
                }).add(A);
                A.offset += k.width + 5;
            ...
            render: function(a, b) {
                var c = this, e = c.chart, h = e.renderer, m = e.container, n = e.options, d = n.exporting && !1 !== n.exporting.enabled && n.navigation && n.navigation.buttonOptions, p = v.lang, r = c.div, k = n.rangeSelector, n = k.floating, t = c.buttons, r = c.inputGroup, u = k.buttonTheme, w = k.buttonPosition, y = k.inputPosition, z = k.inputEnabled, D = u && u.states, B = e.plotLeft, C, G = c.buttonGroup, L;
                L = c.rendered;
                var X = c.options.verticalAlign, Z = e.legend, aa = Z && Z.options, ba = w.y, Y = y.y, ca = L || !1, W = 0, T = 0, U;
                if (!1 !== k.enabled) {
                    L || (c.group = L = h.g("range-selector-group").attr({
                        zIndex: 7
                    }).add(),
                    c.buttonGroup = G = h.g("range-selector-buttons").add(L),
                    c.zoomText = h.text(p.rangeSelectorZoom, f(B + w.x, B), 15).css(k.labelStyle).add(G),
                    C = f(B + w.x, B) + c.zoomText.getBBox().width + 5,
                    l(c.buttonOptions, function(a, b) {
                    ...
                    c.inputGroup = r = h.g("input-group").add(L),
                    r.offset = 0,
                    c.drawInput("min"),
                    c.drawInput("max")));
                    ...
                    !1 !== z && (W = d && this.titleCollision(e) && "top" === X && "right" === y.align && y.y - r.getBBox().height - 12 < (d.y || 0) + d.height + e.spacing[0] ? -40 : 0,
                    "left" === y.align ? U = B : "right" === y.align && (U = -Math.max(e.axisOffset[1], -W)),
                    r.align({
                        y: y.y,
                    ...
                    m = r.alignAttr.translateX + r.alignOptions.x - W + r.getBBox().x + 2,
                    d = r.alignOptions.width,
                    p = G.alignAttr.translateX + G.getBBox().x,
                    U = G.getBBox().width + 20,
                    (y.align === w.align || p + U > m && m + d > p && ba < Y + r.getBBox().height) && r.attr({
                    ...
                    "bottom" === X && (Z = aa && "bottom" === aa.verticalAlign && aa.enabled && !aa.floating ? Z.legendHeight + f(aa.margin, 10) : 0,
                    a = a + Z - 20,
                    T = b - a - (n ? 0 : k.y) - 10);
                    if ("top" === X)
                        n && (T = 0),
                        e.titleOffset && (T = e.titleOffset + e.options.title.margin),
                        T += e.margin[0] - e.spacing[0] || 0;
                    else if ("middle" === X)
                        if (Y === ba)
                            T = 0 > Y ? b + void 0 : b;
                        else if (Y || ba)
                            T = 0 > Y || 0 > ba ? T - Math.min(Y, ba) : b - a + NaN;
                    c.group.translate(k.x, k.y + Math.floor(T));
                    !1 !== z && (c.minInput.style.marginTop = c.group.translateY + "px",
                    c.maxInput.style.marginTop = c.group.translateY + "px");
                    c.rendered = !0
                }
            },
            getHeight: function() {
        ...
        G.prototype.minFromRange = function() {
            var a = this.range, b = {
                month: "Month",
                year: "FullYear"
            }[a.type], c, e = this.max, g, h, l = function(a, c) {
                var d = new Date(a)
                  , e = d["get" + b]();
                d["set" + b](e + c);
            ...
            t(c) || (c = g);
            c <= g && (c = g,
            void 0 === h && (h = l(c, a.count)),
            this.newMax = Math.min(c + h, this.dataMax));
            t(e) || (c = void 0);
            return c
        }
        ;
        C(p, "afterGetContainer", function() {
        ...
        w(p.prototype, "render", function(a, b, c) {
            ...
            this.getAxisMargins(),
            f.render(),
            e = f.options.verticalAlign,
            f.options.floating || ("bottom" === e ? this.extraBottomMargin = !0 : "middle" !== e && (this.extraTopMargin = !0)));
            a.call(this, b, c)
        });
        C(p, "update", function(a) {
            ...
            this.isDirtyBox = !0;
            a && (a.render(),
            b = b.rangeSelector && b.rangeSelector.verticalAlign || a.options && a.options.verticalAlign,
        ...
        p.prototype.adjustPlotArea = function() {
            ...
            this.rangeSelector && (a = a.getHeight(),
    ...
    (function(a) {
        ...
        a.StockChart = a.stockChart = function(b, c, d) {
            var g = e(b) || b.nodeName, k = arguments[g ? 1 : 0], h = k.series, l = a.getOptions(), p, q = f(k.navigator && k.navigator.enabled, l.navigator.enabled, !0), r = q ? {
                startOnTick: !1,
                endOnTick: !1
            } : null, u = {
                marker: {
        ...
        q(p.prototype, "getPlotLinePath", function(c, d, k, h, m, n) {
            var p = this, q = this.isLinked && !this.series ? this.linkedParent.series : this.series, r = p.chart, u = r.renderer, w = p.left, x = p.top, y, A, z, E, B = [], D = [], C, H;
            if ("xAxis" !== p.coll && "yAxis" !== p.coll)
            ...
            b(H) && (p.horiz ? v(C, function(a) {
                ...
                if (y < w || y > w + p.width)
                    m ? y = z = Math.min(Math.max(w, y), w + p.width) : b = !0;
                ...
                if (A < x || A > x + p.height)
                    m ? A = E = Math.min(Math.max(x, A), p.top + p.height) : b = !0;
                b || B.push("M", y, A, "L", z, E)
            }));
        ...
        B(p, "afterDrawCrosshair", function(a) {
            var b, c;
            if (g(this.crosshair.label) && this.crosshair.label.enabled && this.cross) {
                var d = this.chart
                ...
                m || (m = this.crossLabel = d.renderer.label(null, null, null, e.shape || "callout").addClass("highcharts-crosshair-label" + (this.series[0] && " highcharts-color-" + this.series[0].colorIndex)).attr({
                    align: e.align || a,
                ...
                h ? (a = r ? w.plotX + c : v.chartX,
                l += b ? 0 : this.height) : (a = b ? this.width + c : 0,
                l = r ? w.plotY + l : v.chartY);
                n || e.formatter || (this.isDatetimeAxis && (p = "%b %d, %Y"),
                n = "{value" + (p ? ":" + p : "") + "}");
                ...
                if (h) {
                    ...
                    l = m.y - e.height / 2;
                h ? (b = c - e.x,
                c = c + this.width - e.x) : (b = "left" === this.labelAlign ? c : 0,
                c = "right" === this.labelAlign ? c + this.width : d.chartWidth);
                m.translateX < b && (t = b - m.translateX);
                m.translateX + e.width >= c && (t = -(m.translateX + e.width - c));
                m.attr({
                    x: a + t,
                    y: l,
        ...
        F.processData = function() {
            ...
            if (this.xAxis && this.processedYData)
                for (d = this.processedXData,
                e = this.processedYData,
                g = e.length,
                this.pointArrayMap && (c = l("close", this.pointArrayMap),
                -1 === c && (c = l(this.pointValKey || "y", this.pointArrayMap))),
                a = 0; a < g - f; a++)
                    if (h = e[a] && -1 < c ? e[a][c] : e[a],
                    b(h) && d[a + f] >= this.xAxis.min && 0 !== h) {
                        this.compareValue = h;
                        break
                    }
        }
        ...
        q(w.prototype, "render", function(a) {
            this.chart.is3d && this.chart.is3d() || this.chart.polar || !this.xAxis || this.xAxis.isRadial || (!this.clipBox && this.animate ? (this.clipBox = n(this.chart.clipBox),
        ...
        B(m, "update", function(a) {
            a = a.options;
            "scrollbar"in a && this.navigator && (n(!0, this.options.scrollbar, a.scrollbar),
